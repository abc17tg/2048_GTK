...
#region Autogenerated code
	...
	internal class TextBufferSerializeFuncInvoker {
		...
		byte[] InvokeNative (Gtk.TextBuffer register_buffer, Gtk.TextBuffer content_buffer, Gtk.TextIter start, Gtk.TextIter end)
		{
			...
			byte[] __result = GLib.Marshaller.ArrayPtrToArray<byte[]> (native_cb (register_buffer == null ? IntPtr.Zero : register_buffer.Handle, content_buffer == null ? IntPtr.Zero : content_buffer.Handle, native_start, native_end, out native_length, __data), (int)(ulong)native_length, true);
