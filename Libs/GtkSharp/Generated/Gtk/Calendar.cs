...
#region Autogenerated code
	public partial class Calendar : Gtk.Widget {
		...
		delegate IntPtr d_gtk_calendar_new();
		static d_gtk_calendar_new gtk_calendar_new = FuncLoader.LoadFunction<d_gtk_calendar_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_calendar_get_detail_width_chars(IntPtr raw);
		static d_gtk_calendar_get_detail_width_chars gtk_calendar_get_detail_width_chars = FuncLoader.LoadFunction<d_gtk_calendar_get_detail_width_chars>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_detail_width_chars"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_set_detail_width_chars(IntPtr raw, int chars);
		static d_gtk_calendar_set_detail_width_chars gtk_calendar_set_detail_width_chars = FuncLoader.LoadFunction<d_gtk_calendar_set_detail_width_chars>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_set_detail_width_chars"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_calendar_get_detail_height_rows(IntPtr raw);
		static d_gtk_calendar_get_detail_height_rows gtk_calendar_get_detail_height_rows = FuncLoader.LoadFunction<d_gtk_calendar_get_detail_height_rows>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_detail_height_rows"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_set_detail_height_rows(IntPtr raw, int rows);
		static d_gtk_calendar_set_detail_height_rows gtk_calendar_set_detail_height_rows = FuncLoader.LoadFunction<d_gtk_calendar_set_detail_height_rows>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_set_detail_height_rows"));
		...
		public int InnerBorder {
			get {
				var val = (int)StyleGetProperty("inner-border");
				return val;
			}
		}
		...
		public int VerticalSeparation {
			get {
				var val = (int)StyleGetProperty("vertical-separation");
				return val;
			}
		}
		...
		public int HorizontalSeparation {
			get {
				var val = (int)StyleGetProperty("horizontal-separation");
				return val;
			}
		}
		...
		{
			MonthChangedNativeDelegate unmanaged = class_abi.BaseOverride<MonthChangedNativeDelegate>(this.LookupGType(), "month_changed");
		...
		{
			DaySelectedNativeDelegate unmanaged = class_abi.BaseOverride<DaySelectedNativeDelegate>(this.LookupGType(), "day_selected");
			if (unmanaged == null) return;
		...
		{
			DaySelectedDoubleClickNativeDelegate unmanaged = class_abi.BaseOverride<DaySelectedDoubleClickNativeDelegate>(this.LookupGType(), "day_selected_double_click");
			if (unmanaged == null) return;
		...
		{
			PrevMonthNativeDelegate unmanaged = class_abi.BaseOverride<PrevMonthNativeDelegate>(this.LookupGType(), "prev_month");
			if (unmanaged == null) return;
		...
		{
			NextMonthNativeDelegate unmanaged = class_abi.BaseOverride<NextMonthNativeDelegate>(this.LookupGType(), "next_month");
			if (unmanaged == null) return;
		...
		{
			PrevYearNativeDelegate unmanaged = class_abi.BaseOverride<PrevYearNativeDelegate>(this.LookupGType(), "prev_year");
			if (unmanaged == null) return;
		...
		{
			NextYearNativeDelegate unmanaged = class_abi.BaseOverride<NextYearNativeDelegate>(this.LookupGType(), "next_year");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("month_changed"
							...
							, (uint) sizeof( IntPtr ) // month_changed
							, null
							, "day_selected"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("day_selected"
							, -1
							, (uint) sizeof( IntPtr ) // day_selected
							, "month_changed"
						...
						new GLib.AbiField("day_selected_double_click"
							, -1
							, (uint) sizeof( IntPtr ) // day_selected_double_click
							, "day_selected"
							, "prev_month"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_clear_marks(IntPtr raw);
		static d_gtk_calendar_clear_marks gtk_calendar_clear_marks = FuncLoader.LoadFunction<d_gtk_calendar_clear_marks>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_clear_marks"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_get_date(IntPtr raw, out uint year, out uint month, out uint day);
		static d_gtk_calendar_get_date gtk_calendar_get_date = FuncLoader.LoadFunction<d_gtk_calendar_get_date>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_date"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_calendar_get_day_is_marked(IntPtr raw, uint day);
		static d_gtk_calendar_get_day_is_marked gtk_calendar_get_day_is_marked = FuncLoader.LoadFunction<d_gtk_calendar_get_day_is_marked>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_day_is_marked"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_calendar_get_display_options(IntPtr raw);
		static d_gtk_calendar_get_display_options gtk_calendar_get_display_options = FuncLoader.LoadFunction<d_gtk_calendar_get_display_options>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_display_options"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_set_display_options(IntPtr raw, int flags);
		static d_gtk_calendar_set_display_options gtk_calendar_set_display_options = FuncLoader.LoadFunction<d_gtk_calendar_set_display_options>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_set_display_options"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_calendar_get_type();
		static d_gtk_calendar_get_type gtk_calendar_get_type = FuncLoader.LoadFunction<d_gtk_calendar_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_mark_day(IntPtr raw, uint day);
		static d_gtk_calendar_mark_day gtk_calendar_mark_day = FuncLoader.LoadFunction<d_gtk_calendar_mark_day>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_mark_day"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_select_day(IntPtr raw, uint day);
		static d_gtk_calendar_select_day gtk_calendar_select_day = FuncLoader.LoadFunction<d_gtk_calendar_select_day>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_select_day"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_select_month(IntPtr raw, uint month, uint year);
		static d_gtk_calendar_select_month gtk_calendar_select_month = FuncLoader.LoadFunction<d_gtk_calendar_select_month>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_select_month"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_set_detail_func(IntPtr raw, GtkSharp.CalendarDetailFuncNative func, IntPtr data, GLib.DestroyNotify destroy);
		static d_gtk_calendar_set_detail_func gtk_calendar_set_detail_func = FuncLoader.LoadFunction<d_gtk_calendar_set_detail_func>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_set_detail_func"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_calendar_unmark_day(IntPtr raw, uint day);
		static d_gtk_calendar_unmark_day gtk_calendar_unmark_day = FuncLoader.LoadFunction<d_gtk_calendar_unmark_day>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_calendar_unmark_day"));
