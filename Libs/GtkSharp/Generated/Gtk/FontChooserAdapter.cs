...
#region Autogenerated code
	public partial class FontChooserAdapter : GLib.GInterfaceAdapter, Gtk.IFontChooser {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_font_chooser_get_type();
		static d_gtk_font_chooser_get_type gtk_font_chooser_get_type = FuncLoader.LoadFunction<d_gtk_font_chooser_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_font_chooser_get_type"));
