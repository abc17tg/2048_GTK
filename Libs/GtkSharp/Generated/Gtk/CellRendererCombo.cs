...
#region Autogenerated code
	public partial class CellRendererCombo : Gtk.CellRendererText {
		...
		delegate IntPtr d_gtk_cell_renderer_combo_new();
		static d_gtk_cell_renderer_combo_new gtk_cell_renderer_combo_new = FuncLoader.LoadFunction<d_gtk_cell_renderer_combo_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_combo_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_renderer_combo_get_type();
		static d_gtk_cell_renderer_combo_get_type gtk_cell_renderer_combo_get_type = FuncLoader.LoadFunction<d_gtk_cell_renderer_combo_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_combo_get_type"));
