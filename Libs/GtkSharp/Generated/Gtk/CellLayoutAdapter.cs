...
#region Autogenerated code
	public partial class CellLayoutAdapter : GLib.GInterfaceAdapter, Gtk.ICellLayout {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_layout_get_type();
		static d_gtk_cell_layout_get_type gtk_cell_layout_get_type = FuncLoader.LoadFunction<d_gtk_cell_layout_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_layout_get_type"));
