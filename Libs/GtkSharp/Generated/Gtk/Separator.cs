...
#region Autogenerated code
	public partial class Separator : Gtk.Widget, Gtk.IOrientable {
		...
		delegate IntPtr d_gtk_separator_new(int orientation);
		static d_gtk_separator_new gtk_separator_new = FuncLoader.LoadFunction<d_gtk_separator_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_separator_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_separator_get_type();
		static d_gtk_separator_get_type gtk_separator_get_type = FuncLoader.LoadFunction<d_gtk_separator_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_separator_get_type"));
