...
#region Autogenerated code
	public partial class TextBuffer : GLib.Object {
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("insert_pixbuf"
							, -1
							, (uint) sizeof( IntPtr ) // insert_pixbuf
							, "insert_text"
							, "insert_child_anchor"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("insert_child_anchor"
							, -1
							, (uint) sizeof( IntPtr ) // insert_child_anchor
							, "insert_pixbuf"
							, "delete_range"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("delete_range"
							, -1
							, (uint) sizeof( IntPtr ) // delete_range
							, "insert_child_anchor"
							, "changed"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("modified_changed"
							, -1
							, (uint) sizeof( IntPtr ) // modified_changed
							, "changed"
							, "mark_set"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("mark_deleted"
							, -1
							, (uint) sizeof( IntPtr ) // mark_deleted
							, "mark_set"
							, "apply_tag"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("begin_user_action"
							, -1
							, (uint) sizeof( IntPtr ) // begin_user_action
							, "remove_tag"
							, "end_user_action"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("end_user_action"
							, -1
							, (uint) sizeof( IntPtr ) // end_user_action
							, "begin_user_action"
							, "paste_done"
							, (uint) sizeof(IntPtr)
							, 0
		...
		public void GetBounds(out Gtk.TextIter start, out Gtk.TextIter end) {
			IntPtr native_start = Marshal.AllocHGlobal (Marshal.SizeOf<Gtk.TextIter>());
			IntPtr native_end = Marshal.AllocHGlobal (Marshal.SizeOf<Gtk.TextIter>());
