...
#region Autogenerated code
	public partial class Paned : Gtk.Container, Gtk.IOrientable {
		...
		delegate IntPtr d_gtk_paned_new(int orientation);
		static d_gtk_paned_new gtk_paned_new = FuncLoader.LoadFunction<d_gtk_paned_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_paned_get_position(IntPtr raw);
		static d_gtk_paned_get_position gtk_paned_get_position = FuncLoader.LoadFunction<d_gtk_paned_get_position>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_position"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_set_position(IntPtr raw, int position);
		static d_gtk_paned_set_position gtk_paned_set_position = FuncLoader.LoadFunction<d_gtk_paned_set_position>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_set_position"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_paned_get_wide_handle(IntPtr raw);
		static d_gtk_paned_get_wide_handle gtk_paned_get_wide_handle = FuncLoader.LoadFunction<d_gtk_paned_get_wide_handle>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_wide_handle"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_set_wide_handle(IntPtr raw, bool wide);
		static d_gtk_paned_set_wide_handle gtk_paned_set_wide_handle = FuncLoader.LoadFunction<d_gtk_paned_set_wide_handle>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_set_wide_handle"));
		...
		public int HandleSize {
			get {
				var val = (int)StyleGetProperty("handle-size");
				return val;
			}
		}
		...
		{
			CycleChildFocusNativeDelegate unmanaged = class_abi.BaseOverride<CycleChildFocusNativeDelegate>(this.LookupGType(), "cycle_child_focus");
		...
		{
			ToggleHandleFocusNativeDelegate unmanaged = class_abi.BaseOverride<ToggleHandleFocusNativeDelegate>(this.LookupGType(), "toggle_handle_focus");
			if (unmanaged == null) return false;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("cycle_child_focus"
							...
							, (uint) sizeof( IntPtr ) // cycle_child_focus
							, null
							, "toggle_handle_focus"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("toggle_handle_focus"
							, -1
							, (uint) sizeof( IntPtr ) // toggle_handle_focus
							, "cycle_child_focus"
							, "move_handle"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("move_handle"
							, -1
							, (uint) sizeof( IntPtr ) // move_handle
							, "toggle_handle_focus"
							, "cycle_handle_focus"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("cycle_handle_focus"
							, -1
							, (uint) sizeof( IntPtr ) // cycle_handle_focus
							, "move_handle"
							, "accept_position"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("accept_position"
							, -1
							, (uint) sizeof( IntPtr ) // accept_position
							, "cycle_handle_focus"
							, "cancel_position"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("cancel_position"
							, -1
							, (uint) sizeof( IntPtr ) // cancel_position
							, "accept_position"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_add1(IntPtr raw, IntPtr child);
		static d_gtk_paned_add1 gtk_paned_add1 = FuncLoader.LoadFunction<d_gtk_paned_add1>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_add1"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_add2(IntPtr raw, IntPtr child);
		static d_gtk_paned_add2 gtk_paned_add2 = FuncLoader.LoadFunction<d_gtk_paned_add2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_add2"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_paned_get_child1(IntPtr raw);
		static d_gtk_paned_get_child1 gtk_paned_get_child1 = FuncLoader.LoadFunction<d_gtk_paned_get_child1>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_child1"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_paned_get_child2(IntPtr raw);
		static d_gtk_paned_get_child2 gtk_paned_get_child2 = FuncLoader.LoadFunction<d_gtk_paned_get_child2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_child2"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_paned_get_handle_window(IntPtr raw);
		static d_gtk_paned_get_handle_window gtk_paned_get_handle_window = FuncLoader.LoadFunction<d_gtk_paned_get_handle_window>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_handle_window"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_paned_get_type();
		static d_gtk_paned_get_type gtk_paned_get_type = FuncLoader.LoadFunction<d_gtk_paned_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_pack1(IntPtr raw, IntPtr child, bool resize, bool shrink);
		static d_gtk_paned_pack1 gtk_paned_pack1 = FuncLoader.LoadFunction<d_gtk_paned_pack1>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_pack1"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_paned_pack2(IntPtr raw, IntPtr child, bool resize, bool shrink);
		static d_gtk_paned_pack2 gtk_paned_pack2 = FuncLoader.LoadFunction<d_gtk_paned_pack2>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_paned_pack2"));
