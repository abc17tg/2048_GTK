...
#region Autogenerated code
	public partial class ModelMenuItem : Gtk.CheckMenuItem {
		...
		delegate IntPtr d_gtk_model_menu_item_new();
		static d_gtk_model_menu_item_new gtk_model_menu_item_new = FuncLoader.LoadFunction<d_gtk_model_menu_item_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_model_menu_item_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_model_menu_item_get_type();
		static d_gtk_model_menu_item_get_type gtk_model_menu_item_get_type = FuncLoader.LoadFunction<d_gtk_model_menu_item_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_model_menu_item_get_type"));
