...
#region Autogenerated code
	public partial class CellRendererAccel : Gtk.CellRendererText {
		...
		delegate IntPtr d_gtk_cell_renderer_accel_new();
		static d_gtk_cell_renderer_accel_new gtk_cell_renderer_accel_new = FuncLoader.LoadFunction<d_gtk_cell_renderer_accel_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_accel_new"));
		...
		{
			AccelEditedNativeDelegate unmanaged = class_abi.BaseOverride<AccelEditedNativeDelegate>(this.LookupGType(), "accel_edited");
		...
		{
			AccelClearedNativeDelegate unmanaged = class_abi.BaseOverride<AccelClearedNativeDelegate>(this.LookupGType(), "accel_cleared");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("accel_edited"
							...
							, (uint) sizeof( IntPtr ) // accel_edited
							, null
							, "accel_cleared"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("accel_cleared"
							, -1
							, (uint) sizeof( IntPtr ) // accel_cleared
							, "accel_edited"
							, "_gtk_reserved0"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_renderer_accel_get_type();
		static d_gtk_cell_renderer_accel_get_type gtk_cell_renderer_accel_get_type = FuncLoader.LoadFunction<d_gtk_cell_renderer_accel_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_accel_get_type"));
