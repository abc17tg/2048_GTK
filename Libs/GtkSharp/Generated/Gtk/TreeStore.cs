...
#region Autogenerated code
	public partial class TreeStore : GLib.Object, Gtk.ITreeModel, Gtk.ITreeDragSource, Gtk.ITreeDragDest, Gtk.ITreeSortable {
		...
		delegate void d_gtk_tree_store_clear(IntPtr raw);
		static d_gtk_tree_store_clear gtk_tree_store_clear = FuncLoader.LoadFunction<d_gtk_tree_store_clear>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_clear"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_store_get_type();
		static d_gtk_tree_store_get_type gtk_tree_store_get_type = FuncLoader.LoadFunction<d_gtk_tree_store_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_tree_store_is_ancestor(IntPtr raw, IntPtr iter, IntPtr descendant);
		static d_gtk_tree_store_is_ancestor gtk_tree_store_is_ancestor = FuncLoader.LoadFunction<d_gtk_tree_store_is_ancestor>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_is_ancestor"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_tree_store_iter_depth(IntPtr raw, IntPtr iter);
		static d_gtk_tree_store_iter_depth gtk_tree_store_iter_depth = FuncLoader.LoadFunction<d_gtk_tree_store_iter_depth>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_iter_depth"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_tree_store_iter_is_valid(IntPtr raw, IntPtr iter);
		static d_gtk_tree_store_iter_is_valid gtk_tree_store_iter_is_valid = FuncLoader.LoadFunction<d_gtk_tree_store_iter_is_valid>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_iter_is_valid"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_move_after(IntPtr raw, IntPtr iter, IntPtr position);
		static d_gtk_tree_store_move_after gtk_tree_store_move_after = FuncLoader.LoadFunction<d_gtk_tree_store_move_after>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_move_after"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_move_before(IntPtr raw, IntPtr iter, IntPtr position);
		static d_gtk_tree_store_move_before gtk_tree_store_move_before = FuncLoader.LoadFunction<d_gtk_tree_store_move_before>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_move_before"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_tree_store_remove(IntPtr raw, IntPtr iter);
		static d_gtk_tree_store_remove gtk_tree_store_remove = FuncLoader.LoadFunction<d_gtk_tree_store_remove>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_remove"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_reorder(IntPtr raw, IntPtr parent, out int new_order);
		static d_gtk_tree_store_reorder gtk_tree_store_reorder = FuncLoader.LoadFunction<d_gtk_tree_store_reorder>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_reorder"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_set_column_types(IntPtr raw, int n_columns, IntPtr[] types);
		static d_gtk_tree_store_set_column_types gtk_tree_store_set_column_types = FuncLoader.LoadFunction<d_gtk_tree_store_set_column_types>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_set_column_types"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_set_valist(IntPtr raw, IntPtr iter, IntPtr var_args);
		static d_gtk_tree_store_set_valist gtk_tree_store_set_valist = FuncLoader.LoadFunction<d_gtk_tree_store_set_valist>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_set_valist"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_set_value(IntPtr raw, IntPtr iter, int column, IntPtr value);
		static d_gtk_tree_store_set_value gtk_tree_store_set_value = FuncLoader.LoadFunction<d_gtk_tree_store_set_value>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_set_value"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_store_swap(IntPtr raw, IntPtr a, IntPtr b);
		static d_gtk_tree_store_swap gtk_tree_store_swap = FuncLoader.LoadFunction<d_gtk_tree_store_swap>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_store_swap"));
