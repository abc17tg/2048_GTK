...
#region Autogenerated code
	public partial class PadController : Gtk.EventController {
		...
		delegate IntPtr d_gtk_pad_controller_new(IntPtr window, IntPtr group, IntPtr pad);
		static d_gtk_pad_controller_new gtk_pad_controller_new = FuncLoader.LoadFunction<d_gtk_pad_controller_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_pad_controller_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_pad_controller_get_type();
		static d_gtk_pad_controller_get_type gtk_pad_controller_get_type = FuncLoader.LoadFunction<d_gtk_pad_controller_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_pad_controller_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_pad_controller_set_action(IntPtr raw, int type, int index, int mode, IntPtr label, IntPtr action_name);
		static d_gtk_pad_controller_set_action gtk_pad_controller_set_action = FuncLoader.LoadFunction<d_gtk_pad_controller_set_action>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_pad_controller_set_action"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_pad_controller_set_action_entries(IntPtr raw, IntPtr entries, int n_entries);
		static d_gtk_pad_controller_set_action_entries gtk_pad_controller_set_action_entries = FuncLoader.LoadFunction<d_gtk_pad_controller_set_action_entries>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_pad_controller_set_action_entries"));
