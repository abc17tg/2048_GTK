...
#region Autogenerated code
	public partial class Window : Gtk.Bin {
		...
		public string DecorationButtonLayout {
			get {
				var val = (string)StyleGetProperty("decoration-button-layout");
				return val;
			}
		}
		...
		public int DecorationResizeHandle {
			get {
				var val = (int)StyleGetProperty("decoration-resize-handle");
				return val;
			}
		}
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("activate_focus"
							, -1
							, (uint) sizeof( IntPtr ) // activate_focus
							, "set_focus"
							, "activate_default"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("activate_default"
							, -1
							, (uint) sizeof( IntPtr ) // activate_default
							, "activate_focus"
							, "keys_changed"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("enable_debugging"
							, -1
							, (uint) sizeof( IntPtr ) // enable_debugging
							, "keys_changed"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		public static Gtk.Window[] ListToplevels() {
			...
			Gtk.Window[] ret = GLib.Marshaller.ListPtrToArray<Gtk.Window, Gtk.Window> (raw_ret, true, false);
			return ret;
		}
