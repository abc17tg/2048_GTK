...
#region Autogenerated code
	public partial class CellRenderer : GLib.InitiallyUnowned {
		...
		delegate bool d_gtk_cell_renderer_get_visible(IntPtr raw);
		static d_gtk_cell_renderer_get_visible gtk_cell_renderer_get_visible = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_visible>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_visible"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_set_visible(IntPtr raw, bool visible);
		static d_gtk_cell_renderer_set_visible gtk_cell_renderer_set_visible = FuncLoader.LoadFunction<d_gtk_cell_renderer_set_visible>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_set_visible"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_renderer_get_sensitive(IntPtr raw);
		static d_gtk_cell_renderer_get_sensitive gtk_cell_renderer_get_sensitive = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_sensitive>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_sensitive"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_set_sensitive(IntPtr raw, bool sensitive);
		static d_gtk_cell_renderer_set_sensitive gtk_cell_renderer_set_sensitive = FuncLoader.LoadFunction<d_gtk_cell_renderer_set_sensitive>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_set_sensitive"));
		...
		{
			GetAlignedAreaNativeDelegate unmanaged = class_abi.BaseOverride<GetAlignedAreaNativeDelegate>(this.LookupGType(), "get_aligned_area");
		...
		{
			StartEditingNativeDelegate unmanaged = class_abi.BaseOverride<StartEditingNativeDelegate>(this.LookupGType(), "start_editing");
		...
		{
			EditingCanceledNativeDelegate unmanaged = class_abi.BaseOverride<EditingCanceledNativeDelegate>(this.LookupGType(), "editing_canceled");
			if (unmanaged == null) return;
		...
		{
			EditingStartedNativeDelegate unmanaged = class_abi.BaseOverride<EditingStartedNativeDelegate>(this.LookupGType(), "editing_started");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("get_aligned_area"
							, -1
							, (uint) sizeof( IntPtr ) // get_aligned_area
							, "get_preferred_width_for_height"
							, "get_size"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("start_editing"
							, -1
							, (uint) sizeof( IntPtr ) // start_editing
							, "activate"
							, "editing_canceled"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("editing_canceled"
							, -1
							, (uint) sizeof( IntPtr ) // editing_canceled
							, "start_editing"
							, "editing_started"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("editing_started"
							, -1
							, (uint) sizeof( IntPtr ) // editing_started
							, "editing_canceled"
							, "priv"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_renderer_activate(IntPtr raw, IntPtr evnt, IntPtr widget, IntPtr path, IntPtr background_area, IntPtr cell_area, int flags);
		static d_gtk_cell_renderer_activate gtk_cell_renderer_activate = FuncLoader.LoadFunction<d_gtk_cell_renderer_activate>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_activate"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_aligned_area(IntPtr raw, IntPtr widget, int flags, IntPtr cell_area, IntPtr aligned_area);
		static d_gtk_cell_renderer_get_aligned_area gtk_cell_renderer_get_aligned_area = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_aligned_area>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_aligned_area"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_alignment(IntPtr raw, out float xalign, out float yalign);
		static d_gtk_cell_renderer_get_alignment gtk_cell_renderer_get_alignment = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_alignment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_alignment"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_fixed_size(IntPtr raw, out int width, out int height);
		static d_gtk_cell_renderer_get_fixed_size gtk_cell_renderer_get_fixed_size = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_fixed_size>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_fixed_size"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_padding(IntPtr raw, out int xpad, out int ypad);
		static d_gtk_cell_renderer_get_padding gtk_cell_renderer_get_padding = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_padding>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_padding"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_preferred_height(IntPtr raw, IntPtr widget, out int minimum_size, out int natural_size);
		static d_gtk_cell_renderer_get_preferred_height gtk_cell_renderer_get_preferred_height = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_preferred_height>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_preferred_height"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_preferred_height_for_width(IntPtr raw, IntPtr widget, int width, out int minimum_height, out int natural_height);
		static d_gtk_cell_renderer_get_preferred_height_for_width gtk_cell_renderer_get_preferred_height_for_width = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_preferred_height_for_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_preferred_height_for_width"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_preferred_size(IntPtr raw, IntPtr widget, IntPtr minimum_size, IntPtr natural_size);
		static d_gtk_cell_renderer_get_preferred_size gtk_cell_renderer_get_preferred_size = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_preferred_size>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_preferred_size"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_preferred_width(IntPtr raw, IntPtr widget, out int minimum_size, out int natural_size);
		static d_gtk_cell_renderer_get_preferred_width gtk_cell_renderer_get_preferred_width = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_preferred_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_preferred_width"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_get_preferred_width_for_height(IntPtr raw, IntPtr widget, int height, out int minimum_width, out int natural_width);
		static d_gtk_cell_renderer_get_preferred_width_for_height gtk_cell_renderer_get_preferred_width_for_height = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_preferred_width_for_height>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_preferred_width_for_height"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_renderer_get_request_mode(IntPtr raw);
		static d_gtk_cell_renderer_get_request_mode gtk_cell_renderer_get_request_mode = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_request_mode>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_request_mode"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_renderer_get_state(IntPtr raw, IntPtr widget, int cell_state);
		static d_gtk_cell_renderer_get_state gtk_cell_renderer_get_state = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_state>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_state"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_renderer_get_type();
		static d_gtk_cell_renderer_get_type gtk_cell_renderer_get_type = FuncLoader.LoadFunction<d_gtk_cell_renderer_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_renderer_is_activatable(IntPtr raw);
		static d_gtk_cell_renderer_is_activatable gtk_cell_renderer_is_activatable = FuncLoader.LoadFunction<d_gtk_cell_renderer_is_activatable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_is_activatable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_render(IntPtr raw, IntPtr cr, IntPtr widget, IntPtr background_area, IntPtr cell_area, int flags);
		static d_gtk_cell_renderer_render gtk_cell_renderer_render = FuncLoader.LoadFunction<d_gtk_cell_renderer_render>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_render"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_set_alignment(IntPtr raw, float xalign, float yalign);
		static d_gtk_cell_renderer_set_alignment gtk_cell_renderer_set_alignment = FuncLoader.LoadFunction<d_gtk_cell_renderer_set_alignment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_set_alignment"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_set_fixed_size(IntPtr raw, int width, int height);
		static d_gtk_cell_renderer_set_fixed_size gtk_cell_renderer_set_fixed_size = FuncLoader.LoadFunction<d_gtk_cell_renderer_set_fixed_size>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_set_fixed_size"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_set_padding(IntPtr raw, int xpad, int ypad);
		static d_gtk_cell_renderer_set_padding gtk_cell_renderer_set_padding = FuncLoader.LoadFunction<d_gtk_cell_renderer_set_padding>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_set_padding"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_renderer_stop_editing(IntPtr raw, bool canceled);
		static d_gtk_cell_renderer_stop_editing gtk_cell_renderer_stop_editing = FuncLoader.LoadFunction<d_gtk_cell_renderer_stop_editing>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_stop_editing"));
