...
#region Autogenerated code
	public partial class TreeModelFilter : GLib.Object, Gtk.ITreeModel, Gtk.ITreeDragSource {
		...
		delegate IntPtr d_gtk_tree_model_filter_new(IntPtr child_model, IntPtr root);
		static d_gtk_tree_model_filter_new gtk_tree_model_filter_new = FuncLoader.LoadFunction<d_gtk_tree_model_filter_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_new"));
		...
		{
			VisibleNativeDelegate unmanaged = class_abi.BaseOverride<VisibleNativeDelegate>(this.LookupGType(), "visible");
		...
		{
			ModifyNativeDelegate unmanaged = class_abi.BaseOverride<ModifyNativeDelegate>(this.LookupGType(), "modify");
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_model_filter_clear_cache(IntPtr raw);
		static d_gtk_tree_model_filter_clear_cache gtk_tree_model_filter_clear_cache = FuncLoader.LoadFunction<d_gtk_tree_model_filter_clear_cache>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_clear_cache"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_model_filter_convert_child_path_to_path(IntPtr raw, IntPtr child_path);
		static d_gtk_tree_model_filter_convert_child_path_to_path gtk_tree_model_filter_convert_child_path_to_path = FuncLoader.LoadFunction<d_gtk_tree_model_filter_convert_child_path_to_path>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_convert_child_path_to_path"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_model_filter_convert_iter_to_child_iter(IntPtr raw, IntPtr child_iter, IntPtr filter_iter);
		static d_gtk_tree_model_filter_convert_iter_to_child_iter gtk_tree_model_filter_convert_iter_to_child_iter = FuncLoader.LoadFunction<d_gtk_tree_model_filter_convert_iter_to_child_iter>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_convert_iter_to_child_iter"));

		public Gtk.TreeIter ConvertIterToChildIter(Gtk.TreeIter filter_iter) {
			Gtk.TreeIter child_iter;
			IntPtr native_child_iter = Marshal.AllocHGlobal (Marshal.SizeOf<Gtk.TreeIter>());
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_model_filter_convert_path_to_child_path(IntPtr raw, IntPtr filter_path);
		static d_gtk_tree_model_filter_convert_path_to_child_path gtk_tree_model_filter_convert_path_to_child_path = FuncLoader.LoadFunction<d_gtk_tree_model_filter_convert_path_to_child_path>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_convert_path_to_child_path"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_model_filter_get_model(IntPtr raw);
		static d_gtk_tree_model_filter_get_model gtk_tree_model_filter_get_model = FuncLoader.LoadFunction<d_gtk_tree_model_filter_get_model>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_get_model"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_model_filter_get_type();
		static d_gtk_tree_model_filter_get_type gtk_tree_model_filter_get_type = FuncLoader.LoadFunction<d_gtk_tree_model_filter_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_model_filter_refilter(IntPtr raw);
		static d_gtk_tree_model_filter_refilter gtk_tree_model_filter_refilter = FuncLoader.LoadFunction<d_gtk_tree_model_filter_refilter>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_refilter"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_model_filter_set_visible_column(IntPtr raw, int column);
		static d_gtk_tree_model_filter_set_visible_column gtk_tree_model_filter_set_visible_column = FuncLoader.LoadFunction<d_gtk_tree_model_filter_set_visible_column>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_set_visible_column"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_tree_model_filter_set_visible_func(IntPtr raw, GtkSharp.TreeModelFilterVisibleFuncNative func, IntPtr data, GLib.DestroyNotify destroy);
		static d_gtk_tree_model_filter_set_visible_func gtk_tree_model_filter_set_visible_func = FuncLoader.LoadFunction<d_gtk_tree_model_filter_set_visible_func>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_filter_set_visible_func"));
