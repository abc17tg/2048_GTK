...
#region Autogenerated code
	public partial class EntryCompletion : GLib.Object, Gtk.ICellLayout {
		...
		delegate IntPtr d_gtk_entry_completion_new();
		static d_gtk_entry_completion_new gtk_entry_completion_new = FuncLoader.LoadFunction<d_gtk_entry_completion_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_new_with_area(IntPtr area);
		static d_gtk_entry_completion_new_with_area gtk_entry_completion_new_with_area = FuncLoader.LoadFunction<d_gtk_entry_completion_new_with_area>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_new_with_area"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_get_model(IntPtr raw);
		static d_gtk_entry_completion_get_model gtk_entry_completion_get_model = FuncLoader.LoadFunction<d_gtk_entry_completion_get_model>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_model"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_model(IntPtr raw, IntPtr model);
		static d_gtk_entry_completion_set_model gtk_entry_completion_set_model = FuncLoader.LoadFunction<d_gtk_entry_completion_set_model>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_model"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_entry_completion_get_minimum_key_length(IntPtr raw);
		static d_gtk_entry_completion_get_minimum_key_length gtk_entry_completion_get_minimum_key_length = FuncLoader.LoadFunction<d_gtk_entry_completion_get_minimum_key_length>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_minimum_key_length"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_minimum_key_length(IntPtr raw, int length);
		static d_gtk_entry_completion_set_minimum_key_length gtk_entry_completion_set_minimum_key_length = FuncLoader.LoadFunction<d_gtk_entry_completion_set_minimum_key_length>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_minimum_key_length"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_entry_completion_get_text_column(IntPtr raw);
		static d_gtk_entry_completion_get_text_column gtk_entry_completion_get_text_column = FuncLoader.LoadFunction<d_gtk_entry_completion_get_text_column>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_text_column"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_text_column(IntPtr raw, int column);
		static d_gtk_entry_completion_set_text_column gtk_entry_completion_set_text_column = FuncLoader.LoadFunction<d_gtk_entry_completion_set_text_column>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_text_column"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_entry_completion_get_inline_completion(IntPtr raw);
		static d_gtk_entry_completion_get_inline_completion gtk_entry_completion_get_inline_completion = FuncLoader.LoadFunction<d_gtk_entry_completion_get_inline_completion>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_inline_completion"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_inline_completion(IntPtr raw, bool inline_completion);
		static d_gtk_entry_completion_set_inline_completion gtk_entry_completion_set_inline_completion = FuncLoader.LoadFunction<d_gtk_entry_completion_set_inline_completion>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_inline_completion"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_entry_completion_get_popup_completion(IntPtr raw);
		static d_gtk_entry_completion_get_popup_completion gtk_entry_completion_get_popup_completion = FuncLoader.LoadFunction<d_gtk_entry_completion_get_popup_completion>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_popup_completion"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_popup_completion(IntPtr raw, bool popup_completion);
		static d_gtk_entry_completion_set_popup_completion gtk_entry_completion_set_popup_completion = FuncLoader.LoadFunction<d_gtk_entry_completion_set_popup_completion>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_popup_completion"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_entry_completion_get_popup_set_width(IntPtr raw);
		static d_gtk_entry_completion_get_popup_set_width gtk_entry_completion_get_popup_set_width = FuncLoader.LoadFunction<d_gtk_entry_completion_get_popup_set_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_popup_set_width"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_popup_set_width(IntPtr raw, bool popup_set_width);
		static d_gtk_entry_completion_set_popup_set_width gtk_entry_completion_set_popup_set_width = FuncLoader.LoadFunction<d_gtk_entry_completion_set_popup_set_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_popup_set_width"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_entry_completion_get_popup_single_match(IntPtr raw);
		static d_gtk_entry_completion_get_popup_single_match gtk_entry_completion_get_popup_single_match = FuncLoader.LoadFunction<d_gtk_entry_completion_get_popup_single_match>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_popup_single_match"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_popup_single_match(IntPtr raw, bool popup_single_match);
		static d_gtk_entry_completion_set_popup_single_match gtk_entry_completion_set_popup_single_match = FuncLoader.LoadFunction<d_gtk_entry_completion_set_popup_single_match>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_popup_single_match"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_entry_completion_get_inline_selection(IntPtr raw);
		static d_gtk_entry_completion_get_inline_selection gtk_entry_completion_get_inline_selection = FuncLoader.LoadFunction<d_gtk_entry_completion_get_inline_selection>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_inline_selection"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_inline_selection(IntPtr raw, bool inline_selection);
		static d_gtk_entry_completion_set_inline_selection gtk_entry_completion_set_inline_selection = FuncLoader.LoadFunction<d_gtk_entry_completion_set_inline_selection>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_inline_selection"));
		...
		{
			MatchSelectedNativeDelegate unmanaged = class_abi.BaseOverride<MatchSelectedNativeDelegate>(this.LookupGType(), "match_selected");
		...
		{
			PrefixInsertedNativeDelegate unmanaged = class_abi.BaseOverride<PrefixInsertedNativeDelegate>(this.LookupGType(), "insert_prefix");
			if (unmanaged == null) return false;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("match_selected"
							...
							, (uint) sizeof( IntPtr ) // match_selected
							, null
							, "action_activated"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("action_activated"
							, -1
							, (uint) sizeof( IntPtr ) // action_activated
							, "match_selected"
							, "insert_prefix"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("insert_prefix"
							, -1
							, (uint) sizeof( IntPtr ) // insert_prefix
							, "action_activated"
							, "cursor_on_match"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("cursor_on_match"
							, -1
							, (uint) sizeof( IntPtr ) // cursor_on_match
							, "insert_prefix"
							, "no_matches"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("_gtk_reserved0"
							, -1
							, (uint) sizeof( IntPtr ) // _gtk_reserved0
							, "no_matches"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_complete(IntPtr raw);
		static d_gtk_entry_completion_complete gtk_entry_completion_complete = FuncLoader.LoadFunction<d_gtk_entry_completion_complete>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_complete"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_compute_prefix(IntPtr raw, IntPtr key);
		static d_gtk_entry_completion_compute_prefix gtk_entry_completion_compute_prefix = FuncLoader.LoadFunction<d_gtk_entry_completion_compute_prefix>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_compute_prefix"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_delete_action(IntPtr raw, int index_);
		static d_gtk_entry_completion_delete_action gtk_entry_completion_delete_action = FuncLoader.LoadFunction<d_gtk_entry_completion_delete_action>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_delete_action"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_get_completion_prefix(IntPtr raw);
		static d_gtk_entry_completion_get_completion_prefix gtk_entry_completion_get_completion_prefix = FuncLoader.LoadFunction<d_gtk_entry_completion_get_completion_prefix>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_completion_prefix"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_get_entry(IntPtr raw);
		static d_gtk_entry_completion_get_entry gtk_entry_completion_get_entry = FuncLoader.LoadFunction<d_gtk_entry_completion_get_entry>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_entry"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_entry_completion_get_type();
		static d_gtk_entry_completion_get_type gtk_entry_completion_get_type = FuncLoader.LoadFunction<d_gtk_entry_completion_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_insert_action_markup(IntPtr raw, int index_, IntPtr markup);
		static d_gtk_entry_completion_insert_action_markup gtk_entry_completion_insert_action_markup = FuncLoader.LoadFunction<d_gtk_entry_completion_insert_action_markup>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_insert_action_markup"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_insert_action_text(IntPtr raw, int index_, IntPtr text);
		static d_gtk_entry_completion_insert_action_text gtk_entry_completion_insert_action_text = FuncLoader.LoadFunction<d_gtk_entry_completion_insert_action_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_insert_action_text"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_insert_prefix(IntPtr raw);
		static d_gtk_entry_completion_insert_prefix gtk_entry_completion_insert_prefix = FuncLoader.LoadFunction<d_gtk_entry_completion_insert_prefix>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_insert_prefix"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_entry_completion_set_match_func(IntPtr raw, GtkSharp.EntryCompletionMatchFuncNative func, IntPtr func_data, GLib.DestroyNotify func_notify);
		static d_gtk_entry_completion_set_match_func gtk_entry_completion_set_match_func = FuncLoader.LoadFunction<d_gtk_entry_completion_set_match_func>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_entry_completion_set_match_func"));
