...
#region Autogenerated code
	public partial class VBox : Gtk.Box {
		...
		delegate IntPtr d_gtk_vbox_new(bool homogeneous, int spacing);
		static d_gtk_vbox_new gtk_vbox_new = FuncLoader.LoadFunction<d_gtk_vbox_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_vbox_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_vbox_get_type();
		static d_gtk_vbox_get_type gtk_vbox_get_type = FuncLoader.LoadFunction<d_gtk_vbox_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_vbox_get_type"));
