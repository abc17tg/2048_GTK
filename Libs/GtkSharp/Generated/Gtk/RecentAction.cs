...
#region Autogenerated code
	public partial class RecentAction : Gtk.Action, Gtk.IRecentChooser {
		...
		delegate IntPtr d_gtk_recent_action_new(IntPtr name, IntPtr label, IntPtr tooltip, IntPtr stock_id);
		static d_gtk_recent_action_new gtk_recent_action_new = FuncLoader.LoadFunction<d_gtk_recent_action_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_action_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_recent_action_new_for_manager(IntPtr name, IntPtr label, IntPtr tooltip, IntPtr stock_id, IntPtr manager);
		static d_gtk_recent_action_new_for_manager gtk_recent_action_new_for_manager = FuncLoader.LoadFunction<d_gtk_recent_action_new_for_manager>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_action_new_for_manager"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_recent_action_get_show_numbers(IntPtr raw);
		static d_gtk_recent_action_get_show_numbers gtk_recent_action_get_show_numbers = FuncLoader.LoadFunction<d_gtk_recent_action_get_show_numbers>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_action_get_show_numbers"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_recent_action_set_show_numbers(IntPtr raw, bool show_numbers);
		static d_gtk_recent_action_set_show_numbers gtk_recent_action_set_show_numbers = FuncLoader.LoadFunction<d_gtk_recent_action_set_show_numbers>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_action_set_show_numbers"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_recent_action_get_type();
		static d_gtk_recent_action_get_type gtk_recent_action_get_type = FuncLoader.LoadFunction<d_gtk_recent_action_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_action_get_type"));
