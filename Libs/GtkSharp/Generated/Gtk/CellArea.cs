...
#region Autogenerated code
	public partial class CellArea : GLib.InitiallyUnowned {
		...
		{
			AddNativeDelegate unmanaged = class_abi.BaseOverride<AddNativeDelegate>(this.LookupGType(), "add");
		...
		{
			RemoveNativeDelegate unmanaged = class_abi.BaseOverride<RemoveNativeDelegate>(this.LookupGType(), "_remove");
			if (unmanaged == null) return;
		...
		{
			ForeachNativeDelegate unmanaged = class_abi.BaseOverride<ForeachNativeDelegate>(this.LookupGType(), "for_each");
			if (unmanaged == null) return;
		...
		{
			ForeachAllocNativeDelegate unmanaged = class_abi.BaseOverride<ForeachAllocNativeDelegate>(this.LookupGType(), "foreach_alloc");
			if (unmanaged == null) return;
		...
		{
			EventNativeDelegate unmanaged = class_abi.BaseOverride<EventNativeDelegate>(this.LookupGType(), "evnt");
		...
		{
			ApplyAttributesNativeDelegate unmanaged = class_abi.BaseOverride<ApplyAttributesNativeDelegate>(this.LookupGType(), "apply_attributes");
			if (unmanaged == null) return;
		...
		{
			CopyContextNativeDelegate unmanaged = class_abi.BaseOverride<CopyContextNativeDelegate>(this.LookupGType(), "copy_context");
			if (unmanaged == null) return null;
		...
		{
			SetCellPropertyNativeDelegate unmanaged = class_abi.BaseOverride<SetCellPropertyNativeDelegate>(this.LookupGType(), "set_cell_property");
			if (unmanaged == null) return;
		...
		{
			GetCellPropertyNativeDelegate unmanaged = class_abi.BaseOverride<GetCellPropertyNativeDelegate>(this.LookupGType(), "get_cell_property");
			if (unmanaged == null) return;
		...
		{
			FocusNativeDelegate unmanaged = class_abi.BaseOverride<FocusNativeDelegate>(this.LookupGType(), "focus");
		...
		{
			IsActivatableNativeDelegate unmanaged = class_abi.BaseOverride<IsActivatableNativeDelegate>(this.LookupGType(), "is_activatable");
			if (unmanaged == null) return false;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("foreach_alloc"
							, -1
							, (uint) sizeof( IntPtr ) // foreach_alloc
							, "foreach"
							, "event"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("apply_attributes"
							, -1
							, (uint) sizeof( IntPtr ) // apply_attributes
							, "render"
							, "create_context"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("copy_context"
							, -1
							, (uint) sizeof( IntPtr ) // copy_context
							, "create_context"
							, "get_request_mode"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_cell_property"
							, -1
							, (uint) sizeof( IntPtr ) // set_cell_property
							, "get_preferred_width_for_height"
							, "get_cell_property"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_cell_property"
							, -1
							, (uint) sizeof( IntPtr ) // get_cell_property
							, "set_cell_property"
							, "focus"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("is_activatable"
							, -1
							, (uint) sizeof( IntPtr ) // is_activatable
							, "focus"
							, "activate"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_activate(IntPtr raw, IntPtr context, IntPtr widget, IntPtr cell_area, int flags, bool edit_only);
		static d_gtk_cell_area_activate gtk_cell_area_activate = FuncLoader.LoadFunction<d_gtk_cell_area_activate>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_activate"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_activate_cell(IntPtr raw, IntPtr widget, IntPtr renderer, IntPtr evnt, IntPtr cell_area, int flags);
		static d_gtk_cell_area_activate_cell gtk_cell_area_activate_cell = FuncLoader.LoadFunction<d_gtk_cell_area_activate_cell>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_activate_cell"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_add(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_add gtk_cell_area_add = FuncLoader.LoadFunction<d_gtk_cell_area_add>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_add"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_add_focus_sibling(IntPtr raw, IntPtr renderer, IntPtr sibling);
		static d_gtk_cell_area_add_focus_sibling gtk_cell_area_add_focus_sibling = FuncLoader.LoadFunction<d_gtk_cell_area_add_focus_sibling>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_add_focus_sibling"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_apply_attributes(IntPtr raw, IntPtr tree_model, IntPtr iter, bool is_expander, bool is_expanded);
		static d_gtk_cell_area_apply_attributes gtk_cell_area_apply_attributes = FuncLoader.LoadFunction<d_gtk_cell_area_apply_attributes>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_apply_attributes"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_attribute_connect(IntPtr raw, IntPtr renderer, IntPtr attribute, int column);
		static d_gtk_cell_area_attribute_connect gtk_cell_area_attribute_connect = FuncLoader.LoadFunction<d_gtk_cell_area_attribute_connect>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_attribute_connect"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_attribute_disconnect(IntPtr raw, IntPtr renderer, IntPtr attribute);
		static d_gtk_cell_area_attribute_disconnect gtk_cell_area_attribute_disconnect = FuncLoader.LoadFunction<d_gtk_cell_area_attribute_disconnect>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_attribute_disconnect"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_area_attribute_get_column(IntPtr raw, IntPtr renderer, IntPtr attribute);
		static d_gtk_cell_area_attribute_get_column gtk_cell_area_attribute_get_column = FuncLoader.LoadFunction<d_gtk_cell_area_attribute_get_column>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_attribute_get_column"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_cell_get_property(IntPtr raw, IntPtr renderer, IntPtr property_name, IntPtr value);
		static d_gtk_cell_area_cell_get_property gtk_cell_area_cell_get_property = FuncLoader.LoadFunction<d_gtk_cell_area_cell_get_property>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_cell_get_property"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_cell_get_valist(IntPtr raw, IntPtr renderer, IntPtr first_property_name, IntPtr var_args);
		static d_gtk_cell_area_cell_get_valist gtk_cell_area_cell_get_valist = FuncLoader.LoadFunction<d_gtk_cell_area_cell_get_valist>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_cell_get_valist"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_cell_set_property(IntPtr raw, IntPtr renderer, IntPtr property_name, IntPtr value);
		static d_gtk_cell_area_cell_set_property gtk_cell_area_cell_set_property = FuncLoader.LoadFunction<d_gtk_cell_area_cell_set_property>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_cell_set_property"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_cell_set_valist(IntPtr raw, IntPtr renderer, IntPtr first_property_name, IntPtr var_args);
		static d_gtk_cell_area_cell_set_valist gtk_cell_area_cell_set_valist = FuncLoader.LoadFunction<d_gtk_cell_area_cell_set_valist>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_cell_set_valist"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_copy_context(IntPtr raw, IntPtr context);
		static d_gtk_cell_area_copy_context gtk_cell_area_copy_context = FuncLoader.LoadFunction<d_gtk_cell_area_copy_context>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_copy_context"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_create_context(IntPtr raw);
		static d_gtk_cell_area_create_context gtk_cell_area_create_context = FuncLoader.LoadFunction<d_gtk_cell_area_create_context>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_create_context"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_area_event(IntPtr raw, IntPtr context, IntPtr widget, IntPtr evnt, IntPtr cell_area, int flags);
		static d_gtk_cell_area_event gtk_cell_area_event = FuncLoader.LoadFunction<d_gtk_cell_area_event>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_event"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_focus(IntPtr raw, int direction);
		static d_gtk_cell_area_focus gtk_cell_area_focus = FuncLoader.LoadFunction<d_gtk_cell_area_focus>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_focus"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_foreach(IntPtr raw, GtkSharp.CellCallbackNative cb, IntPtr callback_data);
		static d_gtk_cell_area_foreach gtk_cell_area_foreach = FuncLoader.LoadFunction<d_gtk_cell_area_foreach>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_foreach"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_foreach_alloc(IntPtr raw, IntPtr context, IntPtr widget, IntPtr cell_area, IntPtr background_area, GtkSharp.CellAllocCallbackNative cb, IntPtr callback_data);
		static d_gtk_cell_area_foreach_alloc gtk_cell_area_foreach_alloc = FuncLoader.LoadFunction<d_gtk_cell_area_foreach_alloc>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_foreach_alloc"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_get_cell_allocation(IntPtr raw, IntPtr context, IntPtr widget, IntPtr renderer, IntPtr cell_area, IntPtr allocation);
		static d_gtk_cell_area_get_cell_allocation gtk_cell_area_get_cell_allocation = FuncLoader.LoadFunction<d_gtk_cell_area_get_cell_allocation>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_cell_allocation"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_cell_at_position(IntPtr raw, IntPtr context, IntPtr widget, IntPtr cell_area, int x, int y, IntPtr alloc_area);
		static d_gtk_cell_area_get_cell_at_position gtk_cell_area_get_cell_at_position = FuncLoader.LoadFunction<d_gtk_cell_area_get_cell_at_position>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_cell_at_position"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_current_path_string(IntPtr raw);
		static d_gtk_cell_area_get_current_path_string gtk_cell_area_get_current_path_string = FuncLoader.LoadFunction<d_gtk_cell_area_get_current_path_string>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_current_path_string"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_edit_widget(IntPtr raw);
		static d_gtk_cell_area_get_edit_widget gtk_cell_area_get_edit_widget = FuncLoader.LoadFunction<d_gtk_cell_area_get_edit_widget>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_edit_widget"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_edited_cell(IntPtr raw);
		static d_gtk_cell_area_get_edited_cell gtk_cell_area_get_edited_cell = FuncLoader.LoadFunction<d_gtk_cell_area_get_edited_cell>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_edited_cell"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_focus_cell(IntPtr raw);
		static d_gtk_cell_area_get_focus_cell gtk_cell_area_get_focus_cell = FuncLoader.LoadFunction<d_gtk_cell_area_get_focus_cell>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_focus_cell"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_set_focus_cell(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_set_focus_cell gtk_cell_area_set_focus_cell = FuncLoader.LoadFunction<d_gtk_cell_area_set_focus_cell>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_set_focus_cell"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_focus_from_sibling(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_get_focus_from_sibling gtk_cell_area_get_focus_from_sibling = FuncLoader.LoadFunction<d_gtk_cell_area_get_focus_from_sibling>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_focus_from_sibling"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_focus_siblings(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_get_focus_siblings gtk_cell_area_get_focus_siblings = FuncLoader.LoadFunction<d_gtk_cell_area_get_focus_siblings>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_focus_siblings"));
		...
		public Gtk.CellRenderer[] GetFocusSiblings(Gtk.CellRenderer renderer) {
			...
			Gtk.CellRenderer[] ret = GLib.Marshaller.ListPtrToArray<Gtk.CellRenderer, Gtk.CellRenderer> (raw_ret, false, false);
			return ret;
		}

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_get_preferred_height(IntPtr raw, IntPtr context, IntPtr widget, out int minimum_height, out int natural_height);
		static d_gtk_cell_area_get_preferred_height gtk_cell_area_get_preferred_height = FuncLoader.LoadFunction<d_gtk_cell_area_get_preferred_height>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_preferred_height"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_get_preferred_height_for_width(IntPtr raw, IntPtr context, IntPtr widget, int width, out int minimum_height, out int natural_height);
		static d_gtk_cell_area_get_preferred_height_for_width gtk_cell_area_get_preferred_height_for_width = FuncLoader.LoadFunction<d_gtk_cell_area_get_preferred_height_for_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_preferred_height_for_width"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_get_preferred_width(IntPtr raw, IntPtr context, IntPtr widget, out int minimum_width, out int natural_width);
		static d_gtk_cell_area_get_preferred_width gtk_cell_area_get_preferred_width = FuncLoader.LoadFunction<d_gtk_cell_area_get_preferred_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_preferred_width"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_get_preferred_width_for_height(IntPtr raw, IntPtr context, IntPtr widget, int height, out int minimum_width, out int natural_width);
		static d_gtk_cell_area_get_preferred_width_for_height gtk_cell_area_get_preferred_width_for_height = FuncLoader.LoadFunction<d_gtk_cell_area_get_preferred_width_for_height>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_preferred_width_for_height"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_area_get_request_mode(IntPtr raw);
		static d_gtk_cell_area_get_request_mode gtk_cell_area_get_request_mode = FuncLoader.LoadFunction<d_gtk_cell_area_get_request_mode>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_request_mode"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_get_type();
		static d_gtk_cell_area_get_type gtk_cell_area_get_type = FuncLoader.LoadFunction<d_gtk_cell_area_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_has_renderer(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_has_renderer gtk_cell_area_has_renderer = FuncLoader.LoadFunction<d_gtk_cell_area_has_renderer>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_has_renderer"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_inner_cell_area(IntPtr raw, IntPtr widget, IntPtr cell_area, IntPtr inner_area);
		static d_gtk_cell_area_inner_cell_area gtk_cell_area_inner_cell_area = FuncLoader.LoadFunction<d_gtk_cell_area_inner_cell_area>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_inner_cell_area"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_is_activatable(IntPtr raw);
		static d_gtk_cell_area_is_activatable gtk_cell_area_is_activatable = FuncLoader.LoadFunction<d_gtk_cell_area_is_activatable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_is_activatable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_cell_area_is_focus_sibling(IntPtr raw, IntPtr renderer, IntPtr sibling);
		static d_gtk_cell_area_is_focus_sibling gtk_cell_area_is_focus_sibling = FuncLoader.LoadFunction<d_gtk_cell_area_is_focus_sibling>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_is_focus_sibling"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_remove(IntPtr raw, IntPtr renderer);
		static d_gtk_cell_area_remove gtk_cell_area_remove = FuncLoader.LoadFunction<d_gtk_cell_area_remove>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_remove"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_remove_focus_sibling(IntPtr raw, IntPtr renderer, IntPtr sibling);
		static d_gtk_cell_area_remove_focus_sibling gtk_cell_area_remove_focus_sibling = FuncLoader.LoadFunction<d_gtk_cell_area_remove_focus_sibling>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_remove_focus_sibling"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_render(IntPtr raw, IntPtr context, IntPtr widget, IntPtr cr, IntPtr background_area, IntPtr cell_area, int flags, bool paint_focus);
		static d_gtk_cell_area_render gtk_cell_area_render = FuncLoader.LoadFunction<d_gtk_cell_area_render>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_render"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_request_renderer(IntPtr raw, IntPtr renderer, int orientation, IntPtr widget, int for_size, out int minimum_size, out int natural_size);
		static d_gtk_cell_area_request_renderer gtk_cell_area_request_renderer = FuncLoader.LoadFunction<d_gtk_cell_area_request_renderer>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_request_renderer"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_stop_editing(IntPtr raw, bool canceled);
		static d_gtk_cell_area_stop_editing gtk_cell_area_stop_editing = FuncLoader.LoadFunction<d_gtk_cell_area_stop_editing>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_stop_editing"));
