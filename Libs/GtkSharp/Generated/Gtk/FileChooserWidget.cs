...
#region Autogenerated code
	public partial class FileChooserWidget : Gtk.Box, Gtk.IFileChooser {
		...
		delegate IntPtr d_gtk_file_chooser_widget_new(int action);
		static d_gtk_file_chooser_widget_new gtk_file_chooser_widget_new = FuncLoader.LoadFunction<d_gtk_file_chooser_widget_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_file_chooser_widget_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_file_chooser_widget_get_type();
		static d_gtk_file_chooser_widget_get_type gtk_file_chooser_widget_get_type = FuncLoader.LoadFunction<d_gtk_file_chooser_widget_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_file_chooser_widget_get_type"));
