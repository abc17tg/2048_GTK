...
#region Autogenerated code
	public partial class Container : Gtk.Widget {
		...
		delegate int d_gtk_container_get_resize_mode(IntPtr raw);
		static d_gtk_container_get_resize_mode gtk_container_get_resize_mode = FuncLoader.LoadFunction<d_gtk_container_get_resize_mode>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_resize_mode"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_resize_mode(IntPtr raw, int resize_mode);
		static d_gtk_container_set_resize_mode gtk_container_set_resize_mode = FuncLoader.LoadFunction<d_gtk_container_set_resize_mode>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_resize_mode"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate uint d_gtk_container_get_border_width(IntPtr raw);
		static d_gtk_container_get_border_width gtk_container_get_border_width = FuncLoader.LoadFunction<d_gtk_container_get_border_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_border_width"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_border_width(IntPtr raw, uint border_width);
		static d_gtk_container_set_border_width gtk_container_set_border_width = FuncLoader.LoadFunction<d_gtk_container_set_border_width>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_border_width"));
		...
		{
			AddedNativeDelegate unmanaged = class_abi.BaseOverride<AddedNativeDelegate>(this.LookupGType(), "add");
		...
		{
			RemovedNativeDelegate unmanaged = class_abi.BaseOverride<RemovedNativeDelegate>(this.LookupGType(), "remove");
			if (unmanaged == null) return;
		...
		{
			ResizeCheckedNativeDelegate unmanaged = class_abi.BaseOverride<ResizeCheckedNativeDelegate>(this.LookupGType(), "check_resize");
			if (unmanaged == null) return;
		...
		{
			ChildTypeNativeDelegate unmanaged = class_abi.BaseOverride<ChildTypeNativeDelegate>(this.LookupGType(), "child_type");
		...
		{
			CompositeNameNativeDelegate unmanaged = class_abi.BaseOverride<CompositeNameNativeDelegate>(this.LookupGType(), "composite_name");
		...
		{
			GetPathForChildNativeDelegate unmanaged = class_abi.BaseOverride<GetPathForChildNativeDelegate>(this.LookupGType(), "get_path_for_child");
			if (unmanaged == null) return null;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("check_resize"
							, -1
							, (uint) sizeof( IntPtr ) // check_resize
							, "remove"
							, "forall"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_focus_child"
							, -1
							, (uint) sizeof( IntPtr ) // set_focus_child
							, "forall"
							, "child_type"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("composite_name"
							, -1
							, (uint) sizeof( IntPtr ) // composite_name
							, "child_type"
							, "set_child_property"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_child_property"
							, -1
							, (uint) sizeof( IntPtr ) // set_child_property
							, "composite_name"
							, "get_child_property"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_child_property"
							, -1
							, (uint) sizeof( IntPtr ) // get_child_property
							, "set_child_property"
							, "get_path_for_child"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_path_for_child"
							, -1
							, (uint) sizeof( IntPtr ) // get_path_for_child
							, "get_child_property"
						...
						new GLib.AbiField("_handle_border_width"
							, -1
							, (uint) Marshal.SizeOf<bool>() // _handle_border_width
							, "get_path_for_child"
							, "_gtk_reserved1"
							, 1
							, 1
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_check_resize(IntPtr raw);
		static d_gtk_container_check_resize gtk_container_check_resize = FuncLoader.LoadFunction<d_gtk_container_check_resize>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_check_resize"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_child_get_valist(IntPtr raw, IntPtr child, IntPtr first_property_name, IntPtr var_args);
		static d_gtk_container_child_get_valist gtk_container_child_get_valist = FuncLoader.LoadFunction<d_gtk_container_child_get_valist>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_get_valist"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_child_notify(IntPtr raw, IntPtr child, IntPtr child_property);
		static d_gtk_container_child_notify gtk_container_child_notify = FuncLoader.LoadFunction<d_gtk_container_child_notify>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_notify"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_child_notify_by_pspec(IntPtr raw, IntPtr child, IntPtr pspec);
		static d_gtk_container_child_notify_by_pspec gtk_container_child_notify_by_pspec = FuncLoader.LoadFunction<d_gtk_container_child_notify_by_pspec>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_notify_by_pspec"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_child_set_property(IntPtr raw, IntPtr child, IntPtr property_name, IntPtr value);
		static d_gtk_container_child_set_property gtk_container_child_set_property = FuncLoader.LoadFunction<d_gtk_container_child_set_property>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_set_property"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_child_set_valist(IntPtr raw, IntPtr child, IntPtr first_property_name, IntPtr var_args);
		static d_gtk_container_child_set_valist gtk_container_child_set_valist = FuncLoader.LoadFunction<d_gtk_container_child_set_valist>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_set_valist"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_child_type(IntPtr raw);
		static d_gtk_container_child_type gtk_container_child_type = FuncLoader.LoadFunction<d_gtk_container_child_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_child_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_forall(IntPtr raw, GtkSharp.CallbackNative cb, IntPtr callback_data);
		static d_gtk_container_forall gtk_container_forall = FuncLoader.LoadFunction<d_gtk_container_forall>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_forall"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_foreach(IntPtr raw, GtkSharp.CallbackNative cb, IntPtr callback_data);
		static d_gtk_container_foreach gtk_container_foreach = FuncLoader.LoadFunction<d_gtk_container_foreach>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_foreach"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_children(IntPtr raw);
		static d_gtk_container_get_children gtk_container_get_children = FuncLoader.LoadFunction<d_gtk_container_get_children>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_children"));

		public Gtk.Widget[] Children { 
			get {
				IntPtr raw_ret = gtk_container_get_children(Handle);
				Gtk.Widget[] ret = GLib.Marshaller.ListPtrToArray<Gtk.Widget, Gtk.Widget> (raw_ret, true, false);
				return ret;
			}
		}

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_focus_child(IntPtr raw);
		static d_gtk_container_get_focus_child gtk_container_get_focus_child = FuncLoader.LoadFunction<d_gtk_container_get_focus_child>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_focus_child"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_focus_child(IntPtr raw, IntPtr child);
		static d_gtk_container_set_focus_child gtk_container_set_focus_child = FuncLoader.LoadFunction<d_gtk_container_set_focus_child>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_focus_child"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_focus_hadjustment(IntPtr raw);
		static d_gtk_container_get_focus_hadjustment gtk_container_get_focus_hadjustment = FuncLoader.LoadFunction<d_gtk_container_get_focus_hadjustment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_focus_hadjustment"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_focus_hadjustment(IntPtr raw, IntPtr adjustment);
		static d_gtk_container_set_focus_hadjustment gtk_container_set_focus_hadjustment = FuncLoader.LoadFunction<d_gtk_container_set_focus_hadjustment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_focus_hadjustment"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_focus_vadjustment(IntPtr raw);
		static d_gtk_container_get_focus_vadjustment gtk_container_get_focus_vadjustment = FuncLoader.LoadFunction<d_gtk_container_get_focus_vadjustment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_focus_vadjustment"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_focus_vadjustment(IntPtr raw, IntPtr adjustment);
		static d_gtk_container_set_focus_vadjustment gtk_container_set_focus_vadjustment = FuncLoader.LoadFunction<d_gtk_container_set_focus_vadjustment>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_focus_vadjustment"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_path_for_child(IntPtr raw, IntPtr child);
		static d_gtk_container_get_path_for_child gtk_container_get_path_for_child = FuncLoader.LoadFunction<d_gtk_container_get_path_for_child>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_path_for_child"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_container_get_type();
		static d_gtk_container_get_type gtk_container_get_type = FuncLoader.LoadFunction<d_gtk_container_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_propagate_draw(IntPtr raw, IntPtr child, IntPtr cr);
		static d_gtk_container_propagate_draw gtk_container_propagate_draw = FuncLoader.LoadFunction<d_gtk_container_propagate_draw>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_propagate_draw"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_remove(IntPtr raw, IntPtr widget);
		static d_gtk_container_remove gtk_container_remove = FuncLoader.LoadFunction<d_gtk_container_remove>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_remove"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_resize_children(IntPtr raw);
		static d_gtk_container_resize_children gtk_container_resize_children = FuncLoader.LoadFunction<d_gtk_container_resize_children>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_resize_children"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_set_reallocate_redraws(IntPtr raw, bool needs_redraws);
		static d_gtk_container_set_reallocate_redraws gtk_container_set_reallocate_redraws = FuncLoader.LoadFunction<d_gtk_container_set_reallocate_redraws>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_set_reallocate_redraws"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_container_unset_focus_chain(IntPtr raw);
		static d_gtk_container_unset_focus_chain gtk_container_unset_focus_chain = FuncLoader.LoadFunction<d_gtk_container_unset_focus_chain>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_container_unset_focus_chain"));
