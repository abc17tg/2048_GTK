...
#region Autogenerated code
	public partial class CellRendererSpinner : Gtk.CellRenderer {
		...
		delegate IntPtr d_gtk_cell_renderer_spinner_new();
		static d_gtk_cell_renderer_spinner_new gtk_cell_renderer_spinner_new = FuncLoader.LoadFunction<d_gtk_cell_renderer_spinner_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_spinner_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_renderer_spinner_get_type();
		static d_gtk_cell_renderer_spinner_get_type gtk_cell_renderer_spinner_get_type = FuncLoader.LoadFunction<d_gtk_cell_renderer_spinner_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_renderer_spinner_get_type"));
