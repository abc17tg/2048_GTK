...
#region Autogenerated code
	public partial class Overlay : Gtk.Bin {
		...
		delegate IntPtr d_gtk_overlay_new();
		static d_gtk_overlay_new gtk_overlay_new = FuncLoader.LoadFunction<d_gtk_overlay_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_new"));
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("get_child_position"
							...
							, (uint) sizeof( IntPtr ) // get_child_position
							, null
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_overlay_add_overlay(IntPtr raw, IntPtr widget);
		static d_gtk_overlay_add_overlay gtk_overlay_add_overlay = FuncLoader.LoadFunction<d_gtk_overlay_add_overlay>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_add_overlay"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_overlay_get_overlay_pass_through(IntPtr raw, IntPtr widget);
		static d_gtk_overlay_get_overlay_pass_through gtk_overlay_get_overlay_pass_through = FuncLoader.LoadFunction<d_gtk_overlay_get_overlay_pass_through>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_get_overlay_pass_through"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_overlay_get_type();
		static d_gtk_overlay_get_type gtk_overlay_get_type = FuncLoader.LoadFunction<d_gtk_overlay_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_overlay_reorder_overlay(IntPtr raw, IntPtr child, int position);
		static d_gtk_overlay_reorder_overlay gtk_overlay_reorder_overlay = FuncLoader.LoadFunction<d_gtk_overlay_reorder_overlay>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_reorder_overlay"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_overlay_set_overlay_pass_through(IntPtr raw, IntPtr widget, bool pass_through);
		static d_gtk_overlay_set_overlay_pass_through gtk_overlay_set_overlay_pass_through = FuncLoader.LoadFunction<d_gtk_overlay_set_overlay_pass_through>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_overlay_set_overlay_pass_through"));
