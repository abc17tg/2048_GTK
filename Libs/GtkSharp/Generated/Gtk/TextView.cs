...
#region Autogenerated code
	public partial class TextView : Gtk.Container, Gtk.IScrollable {
		...
		public Gdk.Color? ErrorUnderlineColor {
			get {
				var val = (Gdk.Color?)StyleGetProperty("error-underline-color");
				return val;
			}
		}
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("create_buffer"
							, -1
							, (uint) sizeof( IntPtr ) // create_buffer
							, "toggle_overwrite"
							, "draw_layer"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("extend_selection"
							, -1
							, (uint) sizeof( IntPtr ) // extend_selection
							, "draw_layer"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		public bool GetIterAtLocation(out Gtk.TextIter iter, int x, int y) {
			IntPtr native_iter = Marshal.AllocHGlobal (Marshal.SizeOf<Gtk.TextIter>());
		...
		public Gdk.Rectangle GetIterLocation(Gtk.TextIter iter) {
			...
			IntPtr native_iter = GLib.Marshaller.StructureToPtrAlloc (iter);
			IntPtr native_location = Marshal.AllocHGlobal (Marshal.SizeOf<Gdk.Rectangle>());
		...
		public void GetLineAtY(out Gtk.TextIter target_iter, int y, out int line_top) {
			IntPtr native_target_iter = Marshal.AllocHGlobal (Marshal.SizeOf<Gtk.TextIter>());
