...
#region Autogenerated code
	public partial class Notebook : Gtk.Container {
		...
		delegate IntPtr d_gtk_notebook_new();
		static d_gtk_notebook_new gtk_notebook_new = FuncLoader.LoadFunction<d_gtk_notebook_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_get_tab_pos(IntPtr raw);
		static d_gtk_notebook_get_tab_pos gtk_notebook_get_tab_pos = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_pos>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_pos"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_tab_pos(IntPtr raw, int pos);
		static d_gtk_notebook_set_tab_pos gtk_notebook_set_tab_pos = FuncLoader.LoadFunction<d_gtk_notebook_set_tab_pos>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_tab_pos"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_notebook_get_show_tabs(IntPtr raw);
		static d_gtk_notebook_get_show_tabs gtk_notebook_get_show_tabs = FuncLoader.LoadFunction<d_gtk_notebook_get_show_tabs>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_show_tabs"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_show_tabs(IntPtr raw, bool show_tabs);
		static d_gtk_notebook_set_show_tabs gtk_notebook_set_show_tabs = FuncLoader.LoadFunction<d_gtk_notebook_set_show_tabs>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_show_tabs"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_notebook_get_show_border(IntPtr raw);
		static d_gtk_notebook_get_show_border gtk_notebook_get_show_border = FuncLoader.LoadFunction<d_gtk_notebook_get_show_border>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_show_border"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_show_border(IntPtr raw, bool show_border);
		static d_gtk_notebook_set_show_border gtk_notebook_set_show_border = FuncLoader.LoadFunction<d_gtk_notebook_set_show_border>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_show_border"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_notebook_get_scrollable(IntPtr raw);
		static d_gtk_notebook_get_scrollable gtk_notebook_get_scrollable = FuncLoader.LoadFunction<d_gtk_notebook_get_scrollable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_scrollable"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_scrollable(IntPtr raw, bool scrollable);
		static d_gtk_notebook_set_scrollable gtk_notebook_set_scrollable = FuncLoader.LoadFunction<d_gtk_notebook_set_scrollable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_scrollable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_group_name(IntPtr raw);
		static d_gtk_notebook_get_group_name gtk_notebook_get_group_name = FuncLoader.LoadFunction<d_gtk_notebook_get_group_name>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_group_name"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_group_name(IntPtr raw, IntPtr group_name);
		static d_gtk_notebook_set_group_name gtk_notebook_set_group_name = FuncLoader.LoadFunction<d_gtk_notebook_set_group_name>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_group_name"));
		...
		public int TabOverlap {
			get {
				var val = (int)StyleGetProperty("tab-overlap");
				return val;
			}
		}
		...
		public int TabCurvature {
			get {
				var val = (int)StyleGetProperty("tab-curvature");
				return val;
			}
		}
		...
		public int InitialGap {
			get {
				var val = (int)StyleGetProperty("initial-gap");
				return val;
			}
		}
		...
		public bool HasTabGap {
			get {
				var val = (bool)StyleGetProperty("has-tab-gap");
				return val;
			}
		}
		...
		{
			SwitchPageNativeDelegate unmanaged = class_abi.BaseOverride<SwitchPageNativeDelegate>(this.LookupGType(), "switch_page");
		...
		{
			SelectPageNativeDelegate unmanaged = class_abi.BaseOverride<SelectPageNativeDelegate>(this.LookupGType(), "select_page");
		...
		{
			FocusTabNativeDelegate unmanaged = class_abi.BaseOverride<FocusTabNativeDelegate>(this.LookupGType(), "focus_tab");
			if (unmanaged == null) return false;
		...
		{
			ChangeCurrentPageNativeDelegate unmanaged = class_abi.BaseOverride<ChangeCurrentPageNativeDelegate>(this.LookupGType(), "change_current_page");
			if (unmanaged == null) return;
		...
		{
			ReorderTabNativeDelegate unmanaged = class_abi.BaseOverride<ReorderTabNativeDelegate>(this.LookupGType(), "reorder_tab");
			if (unmanaged == null) return;
		...
		{
			InsertPageNativeDelegate unmanaged = class_abi.BaseOverride<InsertPageNativeDelegate>(this.LookupGType(), "insert_page");
		...
		{
			CreateWindowNativeDelegate unmanaged = class_abi.BaseOverride<CreateWindowNativeDelegate>(this.LookupGType(), "create_window");
		...
		{
			PageReorderedNativeDelegate unmanaged = class_abi.BaseOverride<PageReorderedNativeDelegate>(this.LookupGType(), "page_reordered");
			if (unmanaged == null) return;
		...
		{
			PageRemovedNativeDelegate unmanaged = class_abi.BaseOverride<PageRemovedNativeDelegate>(this.LookupGType(), "page_removed");
			if (unmanaged == null) return;
		...
		{
			PageAddedNativeDelegate unmanaged = class_abi.BaseOverride<PageAddedNativeDelegate>(this.LookupGType(), "page_added");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("switch_page"
							...
							, (uint) sizeof( IntPtr ) // switch_page
							, null
							, "select_page"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("select_page"
							, -1
							, (uint) sizeof( IntPtr ) // select_page
							, "switch_page"
							, "focus_tab"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("change_current_page"
							, -1
							, (uint) sizeof( IntPtr ) // change_current_page
							, "focus_tab"
							, "move_focus_out"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("move_focus_out"
							, -1
							, (uint) sizeof( IntPtr ) // move_focus_out
							, "change_current_page"
							, "reorder_tab"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("reorder_tab"
							, -1
							, (uint) sizeof( IntPtr ) // reorder_tab
							, "move_focus_out"
							, "insert_page"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("insert_page"
							, -1
							, (uint) sizeof( IntPtr ) // insert_page
							, "reorder_tab"
							, "create_window"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("create_window"
							, -1
							, (uint) sizeof( IntPtr ) // create_window
							, "insert_page"
							, "page_reordered"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("page_reordered"
							, -1
							, (uint) sizeof( IntPtr ) // page_reordered
							, "create_window"
							, "page_removed"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("page_removed"
							, -1
							, (uint) sizeof( IntPtr ) // page_removed
							, "page_reordered"
							, "page_added"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_append_page(IntPtr raw, IntPtr child, IntPtr tab_label);
		static d_gtk_notebook_append_page gtk_notebook_append_page = FuncLoader.LoadFunction<d_gtk_notebook_append_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_append_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_append_page_menu(IntPtr raw, IntPtr child, IntPtr tab_label, IntPtr menu_label);
		static d_gtk_notebook_append_page_menu gtk_notebook_append_page_menu = FuncLoader.LoadFunction<d_gtk_notebook_append_page_menu>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_append_page_menu"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_detach_tab(IntPtr raw, IntPtr child);
		static d_gtk_notebook_detach_tab gtk_notebook_detach_tab = FuncLoader.LoadFunction<d_gtk_notebook_detach_tab>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_detach_tab"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_action_widget(IntPtr raw, int pack_type);
		static d_gtk_notebook_get_action_widget gtk_notebook_get_action_widget = FuncLoader.LoadFunction<d_gtk_notebook_get_action_widget>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_action_widget"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_get_current_page(IntPtr raw);
		static d_gtk_notebook_get_current_page gtk_notebook_get_current_page = FuncLoader.LoadFunction<d_gtk_notebook_get_current_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_current_page"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_current_page(IntPtr raw, int page_num);
		static d_gtk_notebook_set_current_page gtk_notebook_set_current_page = FuncLoader.LoadFunction<d_gtk_notebook_set_current_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_current_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_menu_label(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_menu_label gtk_notebook_get_menu_label = FuncLoader.LoadFunction<d_gtk_notebook_get_menu_label>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_menu_label"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_menu_label_text(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_menu_label_text gtk_notebook_get_menu_label_text = FuncLoader.LoadFunction<d_gtk_notebook_get_menu_label_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_menu_label_text"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_get_n_pages(IntPtr raw);
		static d_gtk_notebook_get_n_pages gtk_notebook_get_n_pages = FuncLoader.LoadFunction<d_gtk_notebook_get_n_pages>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_n_pages"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_nth_page(IntPtr raw, int page_num);
		static d_gtk_notebook_get_nth_page gtk_notebook_get_nth_page = FuncLoader.LoadFunction<d_gtk_notebook_get_nth_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_nth_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_notebook_get_tab_detachable(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_tab_detachable gtk_notebook_get_tab_detachable = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_detachable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_detachable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate ushort d_gtk_notebook_get_tab_hborder(IntPtr raw);
		static d_gtk_notebook_get_tab_hborder gtk_notebook_get_tab_hborder = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_hborder>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_hborder"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_tab_label(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_tab_label gtk_notebook_get_tab_label = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_label>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_label"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_tab_label_text(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_tab_label_text gtk_notebook_get_tab_label_text = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_label_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_label_text"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_notebook_get_tab_reorderable(IntPtr raw, IntPtr child);
		static d_gtk_notebook_get_tab_reorderable gtk_notebook_get_tab_reorderable = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_reorderable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_reorderable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate ushort d_gtk_notebook_get_tab_vborder(IntPtr raw);
		static d_gtk_notebook_get_tab_vborder gtk_notebook_get_tab_vborder = FuncLoader.LoadFunction<d_gtk_notebook_get_tab_vborder>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_tab_vborder"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_notebook_get_type();
		static d_gtk_notebook_get_type gtk_notebook_get_type = FuncLoader.LoadFunction<d_gtk_notebook_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_insert_page(IntPtr raw, IntPtr child, IntPtr tab_label, int position);
		static d_gtk_notebook_insert_page gtk_notebook_insert_page = FuncLoader.LoadFunction<d_gtk_notebook_insert_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_insert_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_insert_page_menu(IntPtr raw, IntPtr child, IntPtr tab_label, IntPtr menu_label, int position);
		static d_gtk_notebook_insert_page_menu gtk_notebook_insert_page_menu = FuncLoader.LoadFunction<d_gtk_notebook_insert_page_menu>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_insert_page_menu"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_next_page(IntPtr raw);
		static d_gtk_notebook_next_page gtk_notebook_next_page = FuncLoader.LoadFunction<d_gtk_notebook_next_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_next_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_popup_disable(IntPtr raw);
		static d_gtk_notebook_popup_disable gtk_notebook_popup_disable = FuncLoader.LoadFunction<d_gtk_notebook_popup_disable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_popup_disable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_popup_enable(IntPtr raw);
		static d_gtk_notebook_popup_enable gtk_notebook_popup_enable = FuncLoader.LoadFunction<d_gtk_notebook_popup_enable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_popup_enable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_prepend_page(IntPtr raw, IntPtr child, IntPtr tab_label);
		static d_gtk_notebook_prepend_page gtk_notebook_prepend_page = FuncLoader.LoadFunction<d_gtk_notebook_prepend_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_prepend_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_notebook_prepend_page_menu(IntPtr raw, IntPtr child, IntPtr tab_label, IntPtr menu_label);
		static d_gtk_notebook_prepend_page_menu gtk_notebook_prepend_page_menu = FuncLoader.LoadFunction<d_gtk_notebook_prepend_page_menu>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_prepend_page_menu"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_prev_page(IntPtr raw);
		static d_gtk_notebook_prev_page gtk_notebook_prev_page = FuncLoader.LoadFunction<d_gtk_notebook_prev_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_prev_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_remove_page(IntPtr raw, int page_num);
		static d_gtk_notebook_remove_page gtk_notebook_remove_page = FuncLoader.LoadFunction<d_gtk_notebook_remove_page>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_remove_page"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_reorder_child(IntPtr raw, IntPtr child, int position);
		static d_gtk_notebook_reorder_child gtk_notebook_reorder_child = FuncLoader.LoadFunction<d_gtk_notebook_reorder_child>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_reorder_child"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_action_widget(IntPtr raw, IntPtr widget, int pack_type);
		static d_gtk_notebook_set_action_widget gtk_notebook_set_action_widget = FuncLoader.LoadFunction<d_gtk_notebook_set_action_widget>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_action_widget"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_menu_label(IntPtr raw, IntPtr child, IntPtr menu_label);
		static d_gtk_notebook_set_menu_label gtk_notebook_set_menu_label = FuncLoader.LoadFunction<d_gtk_notebook_set_menu_label>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_menu_label"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_menu_label_text(IntPtr raw, IntPtr child, IntPtr menu_text);
		static d_gtk_notebook_set_menu_label_text gtk_notebook_set_menu_label_text = FuncLoader.LoadFunction<d_gtk_notebook_set_menu_label_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_menu_label_text"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_tab_detachable(IntPtr raw, IntPtr child, bool detachable);
		static d_gtk_notebook_set_tab_detachable gtk_notebook_set_tab_detachable = FuncLoader.LoadFunction<d_gtk_notebook_set_tab_detachable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_tab_detachable"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_tab_label(IntPtr raw, IntPtr child, IntPtr tab_label);
		static d_gtk_notebook_set_tab_label gtk_notebook_set_tab_label = FuncLoader.LoadFunction<d_gtk_notebook_set_tab_label>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_tab_label"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_tab_label_text(IntPtr raw, IntPtr child, IntPtr tab_text);
		static d_gtk_notebook_set_tab_label_text gtk_notebook_set_tab_label_text = FuncLoader.LoadFunction<d_gtk_notebook_set_tab_label_text>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_tab_label_text"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_notebook_set_tab_reorderable(IntPtr raw, IntPtr child, bool reorderable);
		static d_gtk_notebook_set_tab_reorderable gtk_notebook_set_tab_reorderable = FuncLoader.LoadFunction<d_gtk_notebook_set_tab_reorderable>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_notebook_set_tab_reorderable"));
