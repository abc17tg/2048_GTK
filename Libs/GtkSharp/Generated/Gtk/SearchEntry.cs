...
#region Autogenerated code
	public partial class SearchEntry : Gtk.Entry {
		...
		delegate IntPtr d_gtk_search_entry_new();
		static d_gtk_search_entry_new gtk_search_entry_new = FuncLoader.LoadFunction<d_gtk_search_entry_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_search_entry_new"));
		...
		{
			SearchChangedNativeDelegate unmanaged = class_abi.BaseOverride<SearchChangedNativeDelegate>(this.LookupGType(), "search_changed");
		...
		{
			NextMatchNativeDelegate unmanaged = class_abi.BaseOverride<NextMatchNativeDelegate>(this.LookupGType(), "next_match");
			if (unmanaged == null) return;
		...
		{
			PreviousMatchNativeDelegate unmanaged = class_abi.BaseOverride<PreviousMatchNativeDelegate>(this.LookupGType(), "previous_match");
			if (unmanaged == null) return;
		...
		{
			StopSearchNativeDelegate unmanaged = class_abi.BaseOverride<StopSearchNativeDelegate>(this.LookupGType(), "stop_search");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("search_changed"
							...
							, (uint) sizeof( IntPtr ) // search_changed
							, null
							, "next_match"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("previous_match"
							, -1
							, (uint) sizeof( IntPtr ) // previous_match
							, "next_match"
							, "stop_search"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("stop_search"
							, -1
							, (uint) sizeof( IntPtr ) // stop_search
							, "previous_match"
							, null
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_search_entry_get_type();
		static d_gtk_search_entry_get_type gtk_search_entry_get_type = FuncLoader.LoadFunction<d_gtk_search_entry_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_search_entry_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_search_entry_handle_event(IntPtr raw, IntPtr evnt);
		static d_gtk_search_entry_handle_event gtk_search_entry_handle_event = FuncLoader.LoadFunction<d_gtk_search_entry_handle_event>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_search_entry_handle_event"));
