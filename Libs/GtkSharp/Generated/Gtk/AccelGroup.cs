...
#region Autogenerated code
	public partial class AccelGroup : GLib.Object {
		...
		delegate IntPtr d_gtk_accel_group_new();
		static d_gtk_accel_group_new gtk_accel_group_new = FuncLoader.LoadFunction<d_gtk_accel_group_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_accel_group_get_is_locked(IntPtr raw);
		static d_gtk_accel_group_get_is_locked gtk_accel_group_get_is_locked = FuncLoader.LoadFunction<d_gtk_accel_group_get_is_locked>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_get_is_locked"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_accel_group_get_modifier_mask(IntPtr raw);
		static d_gtk_accel_group_get_modifier_mask gtk_accel_group_get_modifier_mask = FuncLoader.LoadFunction<d_gtk_accel_group_get_modifier_mask>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_get_modifier_mask"));
		...
		{
			AccelChangedNativeDelegate unmanaged = class_abi.BaseOverride<AccelChangedNativeDelegate>(this.LookupGType(), "accel_changed");
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("accel_changed"
							...
							, (uint) sizeof( IntPtr ) // accel_changed
							, null
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_accel_group_activate(IntPtr raw, int accel_quark, IntPtr acceleratable, uint accel_key, int accel_mods);
		static d_gtk_accel_group_activate gtk_accel_group_activate = FuncLoader.LoadFunction<d_gtk_accel_group_activate>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_activate"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_accel_group_connect(IntPtr raw, uint accel_key, int accel_mods, int accel_flags, IntPtr closure);
		static d_gtk_accel_group_connect gtk_accel_group_connect = FuncLoader.LoadFunction<d_gtk_accel_group_connect>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_connect"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_accel_group_connect_by_path(IntPtr raw, IntPtr accel_path, IntPtr closure);
		static d_gtk_accel_group_connect_by_path gtk_accel_group_connect_by_path = FuncLoader.LoadFunction<d_gtk_accel_group_connect_by_path>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_connect_by_path"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_accel_group_disconnect(IntPtr raw, IntPtr closure);
		static d_gtk_accel_group_disconnect gtk_accel_group_disconnect = FuncLoader.LoadFunction<d_gtk_accel_group_disconnect>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_disconnect"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_accel_group_disconnect_key(IntPtr raw, uint accel_key, int accel_mods);
		static d_gtk_accel_group_disconnect_key gtk_accel_group_disconnect_key = FuncLoader.LoadFunction<d_gtk_accel_group_disconnect_key>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_disconnect_key"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_accel_group_find(IntPtr raw, GtkSharp.AccelGroupFindFuncNative find_func, IntPtr data);
		static d_gtk_accel_group_find gtk_accel_group_find = FuncLoader.LoadFunction<d_gtk_accel_group_find>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_find"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_accel_group_from_accel_closure(IntPtr closure);
		static d_gtk_accel_group_from_accel_closure gtk_accel_group_from_accel_closure = FuncLoader.LoadFunction<d_gtk_accel_group_from_accel_closure>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_from_accel_closure"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_accel_group_get_type();
		static d_gtk_accel_group_get_type gtk_accel_group_get_type = FuncLoader.LoadFunction<d_gtk_accel_group_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_accel_group_lock(IntPtr raw);
		static d_gtk_accel_group_lock gtk_accel_group_lock = FuncLoader.LoadFunction<d_gtk_accel_group_lock>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_lock"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_accel_group_query(IntPtr raw, uint accel_key, int accel_mods, out uint n_entries);
		static d_gtk_accel_group_query gtk_accel_group_query = FuncLoader.LoadFunction<d_gtk_accel_group_query>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_query"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_accel_group_unlock(IntPtr raw);
		static d_gtk_accel_group_unlock gtk_accel_group_unlock = FuncLoader.LoadFunction<d_gtk_accel_group_unlock>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_accel_group_unlock"));
