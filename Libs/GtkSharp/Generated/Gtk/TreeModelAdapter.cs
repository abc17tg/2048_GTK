...
#region Autogenerated code
	public partial class TreeModelAdapter : GLib.GInterfaceAdapter, Gtk.ITreeModel {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_tree_model_get_type();
		static d_gtk_tree_model_get_type gtk_tree_model_get_type = FuncLoader.LoadFunction<d_gtk_tree_model_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_tree_model_get_type"));
