...
#region Autogenerated code
	public partial class Toolbar : Gtk.Container, Gtk.IToolShell, Gtk.IOrientable {
		...
		public int SpaceSize {
			get {
				var val = (int)StyleGetProperty("space-size");
				return val;
			}
		}
		...
		public int InternalPadding {
			get {
				var val = (int)StyleGetProperty("internal-padding");
				return val;
			}
		}
		...
		public int MaxChildExpand {
			get {
				var val = (int)StyleGetProperty("max-child-expand");
				return val;
			}
		}
		...
		public Gtk.ReliefStyle ButtonRelief {
			get {
				var val = (Gtk.ReliefStyle)StyleGetProperty("button-relief");
				return val;
			}
		}
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("orientation_changed"
							...
							, (uint) sizeof( IntPtr ) // orientation_changed
							, null
							, "style_changed"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("style_changed"
							, -1
							, (uint) sizeof( IntPtr ) // style_changed
							, "orientation_changed"
							, "popup_context_menu"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("popup_context_menu"
							, -1
							, (uint) sizeof( IntPtr ) // popup_context_menu
							, "style_changed"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
