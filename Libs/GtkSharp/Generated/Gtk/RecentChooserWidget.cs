...
#region Autogenerated code
	public partial class RecentChooserWidget : Gtk.Box, Gtk.IRecentChooser {
		...
		delegate IntPtr d_gtk_recent_chooser_widget_new();
		static d_gtk_recent_chooser_widget_new gtk_recent_chooser_widget_new = FuncLoader.LoadFunction<d_gtk_recent_chooser_widget_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_chooser_widget_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_recent_chooser_widget_new_for_manager(IntPtr manager);
		static d_gtk_recent_chooser_widget_new_for_manager gtk_recent_chooser_widget_new_for_manager = FuncLoader.LoadFunction<d_gtk_recent_chooser_widget_new_for_manager>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_chooser_widget_new_for_manager"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_recent_chooser_widget_get_type();
		static d_gtk_recent_chooser_widget_get_type gtk_recent_chooser_widget_get_type = FuncLoader.LoadFunction<d_gtk_recent_chooser_widget_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_recent_chooser_widget_get_type"));
