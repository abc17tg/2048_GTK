...
#region Autogenerated code
	public partial class CellAreaBox : Gtk.CellArea, Gtk.ICellLayout, Gtk.IOrientable {
		...
		delegate IntPtr d_gtk_cell_area_box_new();
		static d_gtk_cell_area_box_new gtk_cell_area_box_new = FuncLoader.LoadFunction<d_gtk_cell_area_box_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate int d_gtk_cell_area_box_get_spacing(IntPtr raw);
		static d_gtk_cell_area_box_get_spacing gtk_cell_area_box_get_spacing = FuncLoader.LoadFunction<d_gtk_cell_area_box_get_spacing>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_get_spacing"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_box_set_spacing(IntPtr raw, int spacing);
		static d_gtk_cell_area_box_set_spacing gtk_cell_area_box_set_spacing = FuncLoader.LoadFunction<d_gtk_cell_area_box_set_spacing>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_set_spacing"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_cell_area_box_get_type();
		static d_gtk_cell_area_box_get_type gtk_cell_area_box_get_type = FuncLoader.LoadFunction<d_gtk_cell_area_box_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_box_pack_end(IntPtr raw, IntPtr renderer, bool expand, bool align, bool mfixed);
		static d_gtk_cell_area_box_pack_end gtk_cell_area_box_pack_end = FuncLoader.LoadFunction<d_gtk_cell_area_box_pack_end>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_pack_end"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_cell_area_box_pack_start(IntPtr raw, IntPtr renderer, bool expand, bool align, bool mfixed);
		static d_gtk_cell_area_box_pack_start gtk_cell_area_box_pack_start = FuncLoader.LoadFunction<d_gtk_cell_area_box_pack_start>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_cell_area_box_pack_start"));
