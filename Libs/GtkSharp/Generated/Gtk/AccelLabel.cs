				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("signal_quote1"
							...
							, (uint) sizeof( IntPtr ) // signal_quote1
							, null
							, "signal_quote2"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("signal_quote2"
							, -1
							, (uint) sizeof( IntPtr ) // signal_quote2
							, "signal_quote1"
							, "mod_name_shift"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("mod_name_shift"
							, -1
							, (uint) sizeof( IntPtr ) // mod_name_shift
							, "signal_quote2"
							, "mod_name_control"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("mod_name_control"
							, -1
							, (uint) sizeof( IntPtr ) // mod_name_control
							, "mod_name_shift"
							, "mod_name_alt"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("mod_name_alt"
							, -1
							, (uint) sizeof( IntPtr ) // mod_name_alt
							, "mod_name_control"
							, "mod_separator"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("mod_separator"
							, -1
							, (uint) sizeof( IntPtr ) // mod_separator
							, "mod_name_alt"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
