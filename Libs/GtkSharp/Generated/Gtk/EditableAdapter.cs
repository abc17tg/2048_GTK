...
#region Autogenerated code
	public partial class EditableAdapter : GLib.GInterfaceAdapter, Gtk.IEditable {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_editable_get_type();
		static d_gtk_editable_get_type gtk_editable_get_type = FuncLoader.LoadFunction<d_gtk_editable_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_editable_get_type"));
