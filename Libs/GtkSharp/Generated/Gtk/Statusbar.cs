...
#region Autogenerated code
	public partial class Statusbar : Gtk.Box {
		...
		delegate IntPtr d_gtk_statusbar_new();
		static d_gtk_statusbar_new gtk_statusbar_new = FuncLoader.LoadFunction<d_gtk_statusbar_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_new"));
		...
		{
			TextPoppedNativeDelegate unmanaged = class_abi.BaseOverride<TextPoppedNativeDelegate>(this.LookupGType(), "text_popped");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("text_pushed"
							, -1
							, (uint) sizeof( IntPtr ) // text_pushed
							, "reserved"
							, "text_popped"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("text_popped"
							, -1
							, (uint) sizeof( IntPtr ) // text_popped
							, "text_pushed"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate uint d_gtk_statusbar_get_context_id(IntPtr raw, IntPtr context_description);
		static d_gtk_statusbar_get_context_id gtk_statusbar_get_context_id = FuncLoader.LoadFunction<d_gtk_statusbar_get_context_id>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_get_context_id"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_statusbar_get_message_area(IntPtr raw);
		static d_gtk_statusbar_get_message_area gtk_statusbar_get_message_area = FuncLoader.LoadFunction<d_gtk_statusbar_get_message_area>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_get_message_area"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_statusbar_get_type();
		static d_gtk_statusbar_get_type gtk_statusbar_get_type = FuncLoader.LoadFunction<d_gtk_statusbar_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_statusbar_pop(IntPtr raw, uint context_id);
		static d_gtk_statusbar_pop gtk_statusbar_pop = FuncLoader.LoadFunction<d_gtk_statusbar_pop>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_pop"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate uint d_gtk_statusbar_push(IntPtr raw, uint context_id, IntPtr text);
		static d_gtk_statusbar_push gtk_statusbar_push = FuncLoader.LoadFunction<d_gtk_statusbar_push>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_push"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_statusbar_remove(IntPtr raw, uint context_id, uint message_id);
		static d_gtk_statusbar_remove gtk_statusbar_remove = FuncLoader.LoadFunction<d_gtk_statusbar_remove>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_remove"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_statusbar_remove_all(IntPtr raw, uint context_id);
		static d_gtk_statusbar_remove_all gtk_statusbar_remove_all = FuncLoader.LoadFunction<d_gtk_statusbar_remove_all>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_statusbar_remove_all"));
