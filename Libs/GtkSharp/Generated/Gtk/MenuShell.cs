...
#region Autogenerated code
	public partial class MenuShell : Gtk.Container {
		...
		delegate bool d_gtk_menu_shell_get_take_focus(IntPtr raw);
		static d_gtk_menu_shell_get_take_focus gtk_menu_shell_get_take_focus = FuncLoader.LoadFunction<d_gtk_menu_shell_get_take_focus>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_get_take_focus"));

		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_set_take_focus(IntPtr raw, bool take_focus);
		static d_gtk_menu_shell_set_take_focus gtk_menu_shell_set_take_focus = FuncLoader.LoadFunction<d_gtk_menu_shell_set_take_focus>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_set_take_focus"));
		...
		{
			DeactivatedNativeDelegate unmanaged = class_abi.BaseOverride<DeactivatedNativeDelegate>(this.LookupGType(), "deactivate");
		...
		{
			ActivateCurrentNativeDelegate unmanaged = class_abi.BaseOverride<ActivateCurrentNativeDelegate>(this.LookupGType(), "activate_current");
			if (unmanaged == null) return;
		...
		{
			CanceledNativeDelegate unmanaged = class_abi.BaseOverride<CanceledNativeDelegate>(this.LookupGType(), "cancel");
			if (unmanaged == null) return;
		...
		{
			SelectItemNativeDelegate unmanaged = class_abi.BaseOverride<SelectItemNativeDelegate>(this.LookupGType(), "select_item");
			if (unmanaged == null) return;
		...
		{
			InsertedNativeDelegate unmanaged = class_abi.BaseOverride<InsertedNativeDelegate>(this.LookupGType(), "insert");
			if (unmanaged == null) return;
		...
		{
			GetPopupDelayNativeDelegate unmanaged = class_abi.BaseOverride<GetPopupDelayNativeDelegate>(this.LookupGType(), "get_popup_delay");
		...
		{
			MoveSelectedNativeDelegate unmanaged = class_abi.BaseOverride<MoveSelectedNativeDelegate>(this.LookupGType(), "move_selected");
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("submenu_placement"
							...
							, (uint) Marshal.SizeOf<bool>() // submenu_placement
							, null
							, "deactivate"
							, 1
							, 1
						...
						new GLib.AbiField("selection_done"
							, -1
							, (uint) sizeof( IntPtr ) // selection_done
							, "deactivate"
							, "move_current"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("move_current"
							, -1
							, (uint) sizeof( IntPtr ) // move_current
							, "selection_done"
							, "activate_current"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("activate_current"
							, -1
							, (uint) sizeof( IntPtr ) // activate_current
							, "move_current"
							, "cancel"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("select_item"
							, -1
							, (uint) sizeof( IntPtr ) // select_item
							, "cancel"
							, "insert"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_popup_delay"
							, -1
							, (uint) sizeof( IntPtr ) // get_popup_delay
							, "insert"
							, "move_selected"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("move_selected"
							, -1
							, (uint) sizeof( IntPtr ) // move_selected
							, "get_popup_delay"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_activate_item(IntPtr raw, IntPtr menu_item, bool force_deactivate);
		static d_gtk_menu_shell_activate_item gtk_menu_shell_activate_item = FuncLoader.LoadFunction<d_gtk_menu_shell_activate_item>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_activate_item"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_append(IntPtr raw, IntPtr child);
		static d_gtk_menu_shell_append gtk_menu_shell_append = FuncLoader.LoadFunction<d_gtk_menu_shell_append>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_append"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_bind_model(IntPtr raw, IntPtr model, IntPtr action_namespace, bool with_separators);
		static d_gtk_menu_shell_bind_model gtk_menu_shell_bind_model = FuncLoader.LoadFunction<d_gtk_menu_shell_bind_model>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_bind_model"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_cancel(IntPtr raw);
		static d_gtk_menu_shell_cancel gtk_menu_shell_cancel = FuncLoader.LoadFunction<d_gtk_menu_shell_cancel>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_cancel"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_deactivate(IntPtr raw);
		static d_gtk_menu_shell_deactivate gtk_menu_shell_deactivate = FuncLoader.LoadFunction<d_gtk_menu_shell_deactivate>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_deactivate"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_deselect(IntPtr raw);
		static d_gtk_menu_shell_deselect gtk_menu_shell_deselect = FuncLoader.LoadFunction<d_gtk_menu_shell_deselect>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_deselect"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_menu_shell_get_parent_shell(IntPtr raw);
		static d_gtk_menu_shell_get_parent_shell gtk_menu_shell_get_parent_shell = FuncLoader.LoadFunction<d_gtk_menu_shell_get_parent_shell>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_get_parent_shell"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_menu_shell_get_selected_item(IntPtr raw);
		static d_gtk_menu_shell_get_selected_item gtk_menu_shell_get_selected_item = FuncLoader.LoadFunction<d_gtk_menu_shell_get_selected_item>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_get_selected_item"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_menu_shell_get_type();
		static d_gtk_menu_shell_get_type gtk_menu_shell_get_type = FuncLoader.LoadFunction<d_gtk_menu_shell_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_insert(IntPtr raw, IntPtr child, int position);
		static d_gtk_menu_shell_insert gtk_menu_shell_insert = FuncLoader.LoadFunction<d_gtk_menu_shell_insert>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_insert"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_prepend(IntPtr raw, IntPtr child);
		static d_gtk_menu_shell_prepend gtk_menu_shell_prepend = FuncLoader.LoadFunction<d_gtk_menu_shell_prepend>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_prepend"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_select_first(IntPtr raw, bool search_sensitive);
		static d_gtk_menu_shell_select_first gtk_menu_shell_select_first = FuncLoader.LoadFunction<d_gtk_menu_shell_select_first>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_select_first"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_menu_shell_select_item(IntPtr raw, IntPtr menu_item);
		static d_gtk_menu_shell_select_item gtk_menu_shell_select_item = FuncLoader.LoadFunction<d_gtk_menu_shell_select_item>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_menu_shell_select_item"));
