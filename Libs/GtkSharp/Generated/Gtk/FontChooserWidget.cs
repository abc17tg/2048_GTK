...
#region Autogenerated code
	public partial class FontChooserWidget : Gtk.Box, Gtk.IFontChooser {
		...
		delegate IntPtr d_gtk_font_chooser_widget_new();
		static d_gtk_font_chooser_widget_new gtk_font_chooser_widget_new = FuncLoader.LoadFunction<d_gtk_font_chooser_widget_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_font_chooser_widget_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_font_chooser_widget_get_type();
		static d_gtk_font_chooser_widget_get_type gtk_font_chooser_widget_get_type = FuncLoader.LoadFunction<d_gtk_font_chooser_widget_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_font_chooser_widget_get_type"));
