...
#region Autogenerated code
	public partial class IMContext : GLib.Object {
		...
		{
			PreeditStartNativeDelegate unmanaged = class_abi.BaseOverride<PreeditStartNativeDelegate>(this.LookupGType(), "preedit_start");
		...
		{
			PreeditEndNativeDelegate unmanaged = class_abi.BaseOverride<PreeditEndNativeDelegate>(this.LookupGType(), "preedit_end");
			if (unmanaged == null) return;
		...
		{
			CommitNativeDelegate unmanaged = class_abi.BaseOverride<CommitNativeDelegate>(this.LookupGType(), "commit");
			if (unmanaged == null) return;
		...
		{
			RetrieveSurroundingNativeDelegate unmanaged = class_abi.BaseOverride<RetrieveSurroundingNativeDelegate>(this.LookupGType(), "retrieve_surrounding");
		...
		{
			SurroundingDeletedNativeDelegate unmanaged = class_abi.BaseOverride<SurroundingDeletedNativeDelegate>(this.LookupGType(), "delete_surrounding");
			if (unmanaged == null) return false;
		...
		{
			SetClientWindowNativeDelegate unmanaged = class_abi.BaseOverride<SetClientWindowNativeDelegate>(this.LookupGType(), "set_client_window");
			if (unmanaged == null) return;
		...
		{
			GetPreeditStringNativeDelegate unmanaged = class_abi.BaseOverride<GetPreeditStringNativeDelegate>(this.LookupGType(), "get_preedit_string");
		...
		{
			FilterKeypressNativeDelegate unmanaged = class_abi.BaseOverride<FilterKeypressNativeDelegate>(this.LookupGType(), "filter_keypress");
			if (unmanaged == null) return false;
		...
		{
			FocusInNativeDelegate unmanaged = class_abi.BaseOverride<FocusInNativeDelegate>(this.LookupGType(), "focus_in");
			if (unmanaged == null) return;
		...
		{
			FocusOutNativeDelegate unmanaged = class_abi.BaseOverride<FocusOutNativeDelegate>(this.LookupGType(), "focus_out");
			if (unmanaged == null) return;
		...
		{
			SetCursorLocationNativeDelegate unmanaged = class_abi.BaseOverride<SetCursorLocationNativeDelegate>(this.LookupGType(), "set_cursor_location");
			if (unmanaged == null) return;
		...
		{
			SetUsePreeditNativeDelegate unmanaged = class_abi.BaseOverride<SetUsePreeditNativeDelegate>(this.LookupGType(), "set_use_preedit");
			if (unmanaged == null) return;
		...
		{
			SetSurroundingNativeDelegate unmanaged = class_abi.BaseOverride<SetSurroundingNativeDelegate>(this.LookupGType(), "set_surrounding");
			if (unmanaged == null) return;
		...
		{
			GetSurroundingNativeDelegate unmanaged = class_abi.BaseOverride<GetSurroundingNativeDelegate>(this.LookupGType(), "get_surrounding");
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("preedit_start"
							...
							, (uint) sizeof( IntPtr ) // preedit_start
							, null
							, "preedit_end"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("preedit_end"
							, -1
							, (uint) sizeof( IntPtr ) // preedit_end
							, "preedit_start"
							, "preedit_changed"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("retrieve_surrounding"
							, -1
							, (uint) sizeof( IntPtr ) // retrieve_surrounding
							, "commit"
							, "delete_surrounding"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_client_window"
							, -1
							, (uint) sizeof( IntPtr ) // set_client_window
							, "delete_surrounding"
							, "get_preedit_string"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_preedit_string"
							, -1
							, (uint) sizeof( IntPtr ) // get_preedit_string
							, "set_client_window"
							, "filter_keypress"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("filter_keypress"
							, -1
							, (uint) sizeof( IntPtr ) // filter_keypress
							, "get_preedit_string"
							, "focus_in"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_cursor_location"
							, -1
							, (uint) sizeof( IntPtr ) // set_cursor_location
							, "reset"
							, "set_use_preedit"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_use_preedit"
							, -1
							, (uint) sizeof( IntPtr ) // set_use_preedit
							, "set_cursor_location"
							, "set_surrounding"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("set_surrounding"
							, -1
							, (uint) sizeof( IntPtr ) // set_surrounding
							, "set_use_preedit"
							, "get_surrounding"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("get_surrounding"
							, -1
							, (uint) sizeof( IntPtr ) // get_surrounding
							, "set_surrounding"
							, "_gtk_reserved1"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_im_context_delete_surrounding(IntPtr raw, int offset, int n_chars);
		static d_gtk_im_context_delete_surrounding gtk_im_context_delete_surrounding = FuncLoader.LoadFunction<d_gtk_im_context_delete_surrounding>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_delete_surrounding"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_im_context_filter_keypress(IntPtr raw, IntPtr evnt);
		static d_gtk_im_context_filter_keypress gtk_im_context_filter_keypress = FuncLoader.LoadFunction<d_gtk_im_context_filter_keypress>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_filter_keypress"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_focus_in(IntPtr raw);
		static d_gtk_im_context_focus_in gtk_im_context_focus_in = FuncLoader.LoadFunction<d_gtk_im_context_focus_in>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_focus_in"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_focus_out(IntPtr raw);
		static d_gtk_im_context_focus_out gtk_im_context_focus_out = FuncLoader.LoadFunction<d_gtk_im_context_focus_out>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_focus_out"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_get_preedit_string(IntPtr raw, out IntPtr str, out IntPtr attrs, out int cursor_pos);
		static d_gtk_im_context_get_preedit_string gtk_im_context_get_preedit_string = FuncLoader.LoadFunction<d_gtk_im_context_get_preedit_string>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_get_preedit_string"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gtk_im_context_get_surrounding(IntPtr raw, out IntPtr text, out int cursor_index);
		static d_gtk_im_context_get_surrounding gtk_im_context_get_surrounding = FuncLoader.LoadFunction<d_gtk_im_context_get_surrounding>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_get_surrounding"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_im_context_get_type();
		static d_gtk_im_context_get_type gtk_im_context_get_type = FuncLoader.LoadFunction<d_gtk_im_context_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_reset(IntPtr raw);
		static d_gtk_im_context_reset gtk_im_context_reset = FuncLoader.LoadFunction<d_gtk_im_context_reset>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_reset"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_set_client_window(IntPtr raw, IntPtr window);
		static d_gtk_im_context_set_client_window gtk_im_context_set_client_window = FuncLoader.LoadFunction<d_gtk_im_context_set_client_window>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_set_client_window"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_set_cursor_location(IntPtr raw, IntPtr value);
		static d_gtk_im_context_set_cursor_location gtk_im_context_set_cursor_location = FuncLoader.LoadFunction<d_gtk_im_context_set_cursor_location>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_set_cursor_location"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_set_surrounding(IntPtr raw, IntPtr text, int len, int cursor_index);
		static d_gtk_im_context_set_surrounding gtk_im_context_set_surrounding = FuncLoader.LoadFunction<d_gtk_im_context_set_surrounding>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_set_surrounding"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gtk_im_context_set_use_preedit(IntPtr raw, bool use_preedit);
		static d_gtk_im_context_set_use_preedit gtk_im_context_set_use_preedit = FuncLoader.LoadFunction<d_gtk_im_context_set_use_preedit>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_im_context_set_use_preedit"));
