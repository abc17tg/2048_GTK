...
#region Autogenerated code
	public partial class ColorChooserWidget : Gtk.Box, Gtk.IColorChooser {
		...
		delegate IntPtr d_gtk_color_chooser_widget_new();
		static d_gtk_color_chooser_widget_new gtk_color_chooser_widget_new = FuncLoader.LoadFunction<d_gtk_color_chooser_widget_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_color_chooser_widget_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_color_chooser_widget_get_type();
		static d_gtk_color_chooser_widget_get_type gtk_color_chooser_widget_get_type = FuncLoader.LoadFunction<d_gtk_color_chooser_widget_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_color_chooser_widget_get_type"));
