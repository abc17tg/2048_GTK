...
#region Autogenerated code
	public partial class ColorChooserDialog : Gtk.Dialog, Gtk.IColorChooser {
		...
		delegate IntPtr d_gtk_color_chooser_dialog_new(IntPtr title, IntPtr parent);
		static d_gtk_color_chooser_dialog_new gtk_color_chooser_dialog_new = FuncLoader.LoadFunction<d_gtk_color_chooser_dialog_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_color_chooser_dialog_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gtk_color_chooser_dialog_get_type();
		static d_gtk_color_chooser_dialog_get_type gtk_color_chooser_dialog_get_type = FuncLoader.LoadFunction<d_gtk_color_chooser_dialog_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_color_chooser_dialog_get_type"));
