...
#region Autogenerated code
	public partial class UserMediaPermissionRequest : GLib.Object, WebKit.IPermissionRequest {

		public UserMediaPermissionRequest (IntPtr raw) : base(raw) {}

		protected UserMediaPermissionRequest() : base(IntPtr.Zero)
		{
			CreateNativeObject (new string [0], new GLib.Value [0]);
		}

		[GLib.Property ("is-for-audio-device")]
		public bool IsForAudioDevice {
			get {
				GLib.Value val = GetProperty ("is-for-audio-device");
				bool ret = (bool) val;
				val.Dispose ();
				return ret;
			}
		...
		[GLib.Property ("is-for-video-device")]
		public bool IsForVideoDevice {
			get {
				GLib.Value val = GetProperty ("is-for-video-device");
				bool ret = (bool) val;
				val.Dispose ();
				return ret;
			}
		...
		delegate IntPtr d_webkit_user_media_permission_request_get_type();
		static d_webkit_user_media_permission_request_get_type webkit_user_media_permission_request_get_type = FuncLoader.LoadFunction<d_webkit_user_media_permission_request_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Webkit), "webkit_user_media_permission_request_get_type"));

		public static new GLib.GType GType { 
			get {
				IntPtr raw_ret = webkit_user_media_permission_request_get_type();
		...
		static UserMediaPermissionRequest ()
		{
