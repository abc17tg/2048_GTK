...
#region Autogenerated code
	public partial class OutputStream : GLib.Object {
		...
		{
			WriteFnNativeDelegate unmanaged = class_abi.BaseOverride<WriteFnNativeDelegate>(this.LookupGType(), "write_fn");
		...
		{
			SpliceNativeDelegate unmanaged = class_abi.BaseOverride<SpliceNativeDelegate>(this.LookupGType(), "splice");
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			WriteAsyncNativeDelegate unmanaged = class_abi.BaseOverride<WriteAsyncNativeDelegate>(this.LookupGType(), "write_async");
		...
		{
			WriteFinishNativeDelegate unmanaged = class_abi.BaseOverride<WriteFinishNativeDelegate>(this.LookupGType(), "write_finish");
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			SpliceAsyncNativeDelegate unmanaged = class_abi.BaseOverride<SpliceAsyncNativeDelegate>(this.LookupGType(), "splice_async");
			if (unmanaged == null) return;
		...
		{
			SpliceFinishNativeDelegate unmanaged = class_abi.BaseOverride<SpliceFinishNativeDelegate>(this.LookupGType(), "splice_finish");
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
		...
		{
			FlushAsyncNativeDelegate unmanaged = class_abi.BaseOverride<FlushAsyncNativeDelegate>(this.LookupGType(), "flush_async");
			if (unmanaged == null) return;
		...
		{
			FlushFinishNativeDelegate unmanaged = class_abi.BaseOverride<FlushFinishNativeDelegate>(this.LookupGType(), "flush_finish");
			if (unmanaged == null) throw new InvalidOperationException ("No base method to invoke");
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						...
						new GLib.AbiField("write_async"
							, -1
							, (uint) sizeof( IntPtr ) // write_async
							, "close_fn"
							, "write_finish"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("write_finish"
							, -1
							, (uint) sizeof( IntPtr ) // write_finish
							, "write_async"
							, "splice_async"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("splice_async"
							, -1
							, (uint) sizeof( IntPtr ) // splice_async
							, "write_finish"
							, "splice_finish"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("splice_finish"
							, -1
							, (uint) sizeof( IntPtr ) // splice_finish
							, "splice_async"
							, "flush_async"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("flush_async"
							, -1
							, (uint) sizeof( IntPtr ) // flush_async
							, "splice_finish"
							, "flush_finish"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("flush_finish"
							, -1
							, (uint) sizeof( IntPtr ) // flush_finish
							, "flush_async"
							, "close_async"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_clear_pending(IntPtr raw);
		static d_g_output_stream_clear_pending g_output_stream_clear_pending = FuncLoader.LoadFunction<d_g_output_stream_clear_pending>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_clear_pending"));
		...
		static d_g_output_stream_close g_output_stream_close = FuncLoader.LoadFunction<d_g_output_stream_close>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_close"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_close_async(IntPtr raw, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_close_async g_output_stream_close_async = FuncLoader.LoadFunction<d_g_output_stream_close_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_close_async"));
		...
		static d_g_output_stream_close_finish g_output_stream_close_finish = FuncLoader.LoadFunction<d_g_output_stream_close_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_close_finish"));
		...
		static d_g_output_stream_flush g_output_stream_flush = FuncLoader.LoadFunction<d_g_output_stream_flush>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_flush"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_flush_async(IntPtr raw, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_flush_async g_output_stream_flush_async = FuncLoader.LoadFunction<d_g_output_stream_flush_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_flush_async"));
		...
		static d_g_output_stream_flush_finish g_output_stream_flush_finish = FuncLoader.LoadFunction<d_g_output_stream_flush_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_flush_finish"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_get_type();
		static d_g_output_stream_get_type g_output_stream_get_type = FuncLoader.LoadFunction<d_g_output_stream_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_g_output_stream_has_pending(IntPtr raw);
		static d_g_output_stream_has_pending g_output_stream_has_pending = FuncLoader.LoadFunction<d_g_output_stream_has_pending>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_has_pending"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_g_output_stream_is_closed(IntPtr raw);
		static d_g_output_stream_is_closed g_output_stream_is_closed = FuncLoader.LoadFunction<d_g_output_stream_is_closed>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_is_closed"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_g_output_stream_is_closing(IntPtr raw);
		static d_g_output_stream_is_closing g_output_stream_is_closing = FuncLoader.LoadFunction<d_g_output_stream_is_closing>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_is_closing"));
		...
		static d_g_output_stream_set_pending g_output_stream_set_pending = FuncLoader.LoadFunction<d_g_output_stream_set_pending>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_set_pending"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_splice(IntPtr raw, IntPtr source, int flags, IntPtr cancellable, out IntPtr error);
		static d_g_output_stream_splice g_output_stream_splice = FuncLoader.LoadFunction<d_g_output_stream_splice>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_splice"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_splice_async(IntPtr raw, IntPtr source, int flags, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_splice_async g_output_stream_splice_async = FuncLoader.LoadFunction<d_g_output_stream_splice_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_splice_async"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_splice_finish(IntPtr raw, IntPtr result, out IntPtr error);
		static d_g_output_stream_splice_finish g_output_stream_splice_finish = FuncLoader.LoadFunction<d_g_output_stream_splice_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_splice_finish"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_write(IntPtr raw, byte[] buffer, UIntPtr count, IntPtr cancellable, out IntPtr error);
		static d_g_output_stream_write g_output_stream_write = FuncLoader.LoadFunction<d_g_output_stream_write>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_g_output_stream_write_all(IntPtr raw, byte[] buffer, UIntPtr count, out UIntPtr bytes_written, IntPtr cancellable, out IntPtr error);
		static d_g_output_stream_write_all g_output_stream_write_all = FuncLoader.LoadFunction<d_g_output_stream_write_all>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_all"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_write_all_async(IntPtr raw, IntPtr buffer, UIntPtr count, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_write_all_async g_output_stream_write_all_async = FuncLoader.LoadFunction<d_g_output_stream_write_all_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_all_async"));
		...
		static d_g_output_stream_write_all_finish g_output_stream_write_all_finish = FuncLoader.LoadFunction<d_g_output_stream_write_all_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_all_finish"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_write_async(IntPtr raw, byte[] buffer, UIntPtr count, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_write_async g_output_stream_write_async = FuncLoader.LoadFunction<d_g_output_stream_write_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_async"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_write_bytes(IntPtr raw, IntPtr bytes, IntPtr cancellable, out IntPtr error);
		static d_g_output_stream_write_bytes g_output_stream_write_bytes = FuncLoader.LoadFunction<d_g_output_stream_write_bytes>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_bytes"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_output_stream_write_bytes_async(IntPtr raw, IntPtr bytes, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_output_stream_write_bytes_async g_output_stream_write_bytes_async = FuncLoader.LoadFunction<d_g_output_stream_write_bytes_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_bytes_async"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_write_bytes_finish(IntPtr raw, IntPtr result, out IntPtr error);
		static d_g_output_stream_write_bytes_finish g_output_stream_write_bytes_finish = FuncLoader.LoadFunction<d_g_output_stream_write_bytes_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_bytes_finish"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_output_stream_write_finish(IntPtr raw, IntPtr result, out IntPtr error);
		static d_g_output_stream_write_finish g_output_stream_write_finish = FuncLoader.LoadFunction<d_g_output_stream_write_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_output_stream_write_finish"));
