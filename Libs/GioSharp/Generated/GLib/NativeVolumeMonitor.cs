...
#region Autogenerated code
	public partial class NativeVolumeMonitor : GLib.VolumeMonitor {
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("get_mount_for_mount_path"
							...
							, (uint) sizeof( IntPtr ) // get_mount_for_mount_path
							, null
							, null
							, (uint) sizeof(IntPtr)
							, 0
		...
		delegate IntPtr d_g_native_volume_monitor_get_type();
		static d_g_native_volume_monitor_get_type g_native_volume_monitor_get_type = FuncLoader.LoadFunction<d_g_native_volume_monitor_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_native_volume_monitor_get_type"));
