...
#region Autogenerated code
	public partial class FileInputStream : GLib.InputStream, GLib.ISeekable {
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_file_input_stream_get_type();
		static d_g_file_input_stream_get_type g_file_input_stream_get_type = FuncLoader.LoadFunction<d_g_file_input_stream_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_file_input_stream_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_file_input_stream_query_info(IntPtr raw, IntPtr attributes, IntPtr cancellable, out IntPtr error);
		static d_g_file_input_stream_query_info g_file_input_stream_query_info = FuncLoader.LoadFunction<d_g_file_input_stream_query_info>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_file_input_stream_query_info"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_g_file_input_stream_query_info_async(IntPtr raw, IntPtr attributes, int io_priority, IntPtr cancellable, GLibSharp.AsyncReadyCallbackNative cb, IntPtr user_data);
		static d_g_file_input_stream_query_info_async g_file_input_stream_query_info_async = FuncLoader.LoadFunction<d_g_file_input_stream_query_info_async>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_file_input_stream_query_info_async"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_file_input_stream_query_info_finish(IntPtr raw, IntPtr result, out IntPtr error);
		static d_g_file_input_stream_query_info_finish g_file_input_stream_query_info_finish = FuncLoader.LoadFunction<d_g_file_input_stream_query_info_finish>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_file_input_stream_query_info_finish"));
