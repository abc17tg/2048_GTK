...
#region Autogenerated code
	public partial class SimpleIOStream : GLib.IOStream {
		...
		delegate IntPtr d_g_simple_io_stream_new(IntPtr input_stream, IntPtr output_stream);
		static d_g_simple_io_stream_new g_simple_io_stream_new = FuncLoader.LoadFunction<d_g_simple_io_stream_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_simple_io_stream_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_g_simple_io_stream_get_type();
		static d_g_simple_io_stream_get_type g_simple_io_stream_get_type = FuncLoader.LoadFunction<d_g_simple_io_stream_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gio), "g_simple_io_stream_get_type"));
