...
#region Autogenerated code
	public partial class PixbufLoader : GLib.Object {
		...
		delegate IntPtr d_gdk_pixbuf_loader_new();
		static d_gdk_pixbuf_loader_new gdk_pixbuf_loader_new = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_new>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_new"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_new_with_mime_type(IntPtr mime_type, out IntPtr error);
		static d_gdk_pixbuf_loader_new_with_mime_type gdk_pixbuf_loader_new_with_mime_type = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_new_with_mime_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_new_with_mime_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_new_with_type(IntPtr image_type, out IntPtr error);
		static d_gdk_pixbuf_loader_new_with_type gdk_pixbuf_loader_new_with_type = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_new_with_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_new_with_type"));
		...
		{
			SizePreparedNativeDelegate unmanaged = class_abi.BaseOverride<SizePreparedNativeDelegate>(this.LookupGType(), "size_prepared");
		...
		{
			AreaPreparedNativeDelegate unmanaged = class_abi.BaseOverride<AreaPreparedNativeDelegate>(this.LookupGType(), "area_prepared");
			if (unmanaged == null) return;
		...
		{
			AreaUpdatedNativeDelegate unmanaged = class_abi.BaseOverride<AreaUpdatedNativeDelegate>(this.LookupGType(), "area_updated");
			if (unmanaged == null) return;
				...
				if (_class_abi == null)
					_class_abi = new GLib.AbiStruct (new List<GLib.AbiField>{ 
						new GLib.AbiField("size_prepared"
							...
							, (uint) sizeof( IntPtr ) // size_prepared
							, null
							, "area_prepared"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("area_prepared"
							, -1
							, (uint) sizeof( IntPtr ) // area_prepared
							, "size_prepared"
							, "area_updated"
							, (uint) sizeof(IntPtr)
							, 0
						...
						new GLib.AbiField("area_updated"
							, -1
							, (uint) sizeof( IntPtr ) // area_updated
							, "area_prepared"
							, "closed"
							, (uint) sizeof(IntPtr)
							, 0
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gdk_pixbuf_loader_close(IntPtr raw, out IntPtr error);
		static d_gdk_pixbuf_loader_close gdk_pixbuf_loader_close = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_close>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_close"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_get_animation(IntPtr raw);
		static d_gdk_pixbuf_loader_get_animation gdk_pixbuf_loader_get_animation = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_get_animation>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_get_animation"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_get_format(IntPtr raw);
		static d_gdk_pixbuf_loader_get_format gdk_pixbuf_loader_get_format = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_get_format>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_get_format"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_get_pixbuf(IntPtr raw);
		static d_gdk_pixbuf_loader_get_pixbuf gdk_pixbuf_loader_get_pixbuf = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_get_pixbuf>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_get_pixbuf"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate IntPtr d_gdk_pixbuf_loader_get_type();
		static d_gdk_pixbuf_loader_get_type gdk_pixbuf_loader_get_type = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_get_type>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_get_type"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate void d_gdk_pixbuf_loader_set_size(IntPtr raw, int width, int height);
		static d_gdk_pixbuf_loader_set_size gdk_pixbuf_loader_set_size = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_set_size>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_set_size"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gdk_pixbuf_loader_write(IntPtr raw, byte[] buf, UIntPtr count, out IntPtr error);
		static d_gdk_pixbuf_loader_write gdk_pixbuf_loader_write = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_write>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_write"));
		...
		[UnmanagedFunctionPointer (CallingConvention.Cdecl)]
		delegate bool d_gdk_pixbuf_loader_write_bytes(IntPtr raw, IntPtr buffer, out IntPtr error);
		static d_gdk_pixbuf_loader_write_bytes gdk_pixbuf_loader_write_bytes = FuncLoader.LoadFunction<d_gdk_pixbuf_loader_write_bytes>(FuncLoader.GetProcAddress(GLibrary.Load(Library.GdkPixbuf), "gdk_pixbuf_loader_write_bytes"));
